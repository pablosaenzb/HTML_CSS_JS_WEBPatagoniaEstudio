...
<form method="post" action="setup-config.php?step=2">
	...
	<table class="form-table" role="presentation">
		...
		<tr>
			...
			<td><input name="dbhost" id="dbhost" type="text" aria-describedby="dbhost-desc" size="25" value="127.0.0.1" /></td>
			<td id="dbhost-desc">
			<?php
				/* translators: %s: 127.0.0.1 */
				printf( __( 'You should be able to get this info from your web host, if %s doesn&#8217;t work.' ), '<code>127.0.0.1</code>' );
			?>
			</td>
		</tr>
		<tr>
