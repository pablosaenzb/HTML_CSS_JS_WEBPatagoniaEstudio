...
function themify_shop_layout($data=array()){
    ...
    $output .= '<p><span class="label">' . __('Rating Stars', 'themify') . '</span>
				<label for="setting-show_product_rating_stars"><input type="checkbox" id="setting-show_product_rating_stars" name="setting-show_product_rating_stars" '.checked( themify_get( 'setting-show_product_rating_stars' ), 'on', false ).' /> ' . __('Show product rating stars', 'themify') . '</label></p>';
