...
?>
	...
	<?php if($query->max_num_pages>1):?>
		<div class="view-all-wrap"> 
			...
			<?php if(($is_woocmerce_active && ($is_post || $is_page)) || (!$is_woocmerce_active && $is_post && $is_page)):?>
				<?php if($is_woocmerce_active):?>
					<a id="result-link-product" href="<?php echo esc_url( add_query_arg( array( 'post_type' => 'product' ), $search_link ) ); ?>" class="view-all-button"><?php _e('View All Products','themify')?></a> 
				<?php endif;?>
				<?php if($is_post):?>
					<a id="result-link-post" href="<?php echo esc_url( add_query_arg( array( 'type' => 'post' ), $search_link ) ); ?>" class="view-all-button"><?php _e('View All Posts','themify')?></a> 
				<?php endif;?>
				<?php if($is_page):?>
					<a id="result-link-page" href="<?php echo esc_url( add_query_arg( array( 'type' => 'page' ), $search_link ) ); ?>" class="view-all-button"><?php _e('View All Pages','themify')?></a> 
				<?php endif;?>
			<?php endif;?>
