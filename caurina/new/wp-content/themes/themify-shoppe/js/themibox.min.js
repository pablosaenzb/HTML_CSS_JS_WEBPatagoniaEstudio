...
document.documentElement.offsetHeight),Math.max(document.body.clientHeight,document.documentElement.clientHeight))},800,function(){a("body").removeClass("post-lightbox").css("overflow-y","visible");a(".post-lightbox-iframe").empty();a(window).resize();a("body").trigger("themiboxclosed");Themibox.lightboxOpen=!1});else{var c=a(".themibox-clicked").closest(".type-product").find(".product-image");a(".post-lightbox-main-image");c=c.length?c:a(".themibox-clicked").closest(".type-product");b.addClass("animate_start post-lightbox-prepare animate_closing").animate({width:c.outerWidth(!0),
