...
c=new Swiper(d,{direction:"vertical",slidesPerView:"auto",freeMode:!0,watchSlidesVisibility:!0,watchSlidesProgress:!0,touchReleaseOnEdges:!0,on:{init:function(){d.addClass("themify_show").closest(".images").find(".themify_spinner").remove()}}});new Swiper(b,{slideToClickedSlide:!0,on:{init:function(a){b.addClass("themify_swiper_ready").closest(".images").find(".themify_spinner").remove()},slideChangeTransitionStart:function(){var d=b.find(".swiper-slide-active"),c=d.children("div.default_img");0<
c.length&&c.replaceWith('<span class="themify_spinner"></span><img class="swiper_img_progress" src="'+c.data("src")+'" width="'+c.data("width")+'" height="'+c.data("height")+'" alt="'+c.data("alt")+'" title="'+c.data("title")+'" />').imagesLoaded(function(){d.children("img.swiper_img_progress").addClass("swiper_img_loaded").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(b){a(this).prev(".themify_spinner").remove()})})}},navigation:{nextEl:".swiper-button-next",
prevEl:".swiper-button-prev"},thumbs:{swiper:c}})}});a("img",b).on("click",function(){var c=thumbs.data("swiper");c&&c.slideTo(a("li",b).index(a(this).parent()))})}0<a(".swiper-container .swiper-slide").length&&("undefined"===typeof Swiper?Themify.LoadAsync(themifyScript.theme_url+"/js/swiper.jquery.min.js",b,null,null,function(){return"undefined"!==typeof Swiper}):b())};a(document).ajaxComplete(function(b,c,d){0<a(".product-slider").not(".hovered").length&&v()});t();v();"undefined"!==typeof themifyShop.wishlist&&
Themify.LoadAsync(themifyScript.theme_url+"/js/themify.wishlist.js",null,null,null);a("#cart-link").themifySideMenu({panel:"#slide-cart",close:"#cart-icon-close"});var w=a(".widget_product_categories .count");0<w.length&&w.each(function(){a(this).text(a(this).text().replace("(","").replace(")",""))});l.on("wc_fragments_refreshed",function(){a(".is_mobile #cart-wrap").show()});"yes"==woocommerce_params.option_ajax_add_to_cart&&(l.on("adding_to_cart",function(a,c,d){"undefined"!==typeof clickSpark&&
(clickSpark.setParticleText("\ue60d"),clickSpark.setParticleColor(window.sparkling_color),clickSpark.setParticleDuration(300),clickSpark.setParticleCount(15),clickSpark.setParticleSpeed(8),clickSpark.setAnimationType("splash"),clickSpark.setParticleRotationSpeed(0),clickSpark.fireParticles(c))}).on("added_to_cart removed_from_cart",function(b,c,d){a(".is_mobile #cart-wrap").show();a.fn.prettyPhoto&&a(".pp_inline").is(":visible")&&a.prettyPhoto.close();a(".mfp-content.themify_product_ajax").is(":visible")&&
a.magnificPopup.close();b=a("#cart-icon-count");!b.hasClass("empty-cart")&&0>=parseInt(b.find(".icon-menu-count").text())?b.addClass("empty-cart"):b.hasClass("empty-cart")&&b.removeClass("empty-cart")}),a(document).on("click",".remove-item-js",function(b){b.preventDefault();var c=a(this);b={action:"theme_delete_cart",remove_item:c.attr("data-product-key")};c.addClass("themify_spinner");a.post(woocommerce_params.ajax_url,b,function(b){var d=b.fragments;b=b.cart_hash;0==c.parent().find(".added_to_cart").size()&&
c.addClass("added");d&&a.each(d,function(b,c){a(b).addClass("updating").replaceWith(c)});a("body").trigger("removed_from_cart",[d,b]);c.removeClass("themify_spinner");a("#cart-icon-count").hasClass("cart_empty")&&l.addClass("wc-cart-empty")})}),themifyScript.ajaxSingleCart||e());a(".reply-review").click(function(){a("#respond").slideToggle("slow");return!1});a(".add-reply-js").click(function(){a(this).hide();a("#respond").slideDown("slow");a("#cancel-comment-reply-link").show();return!1});a("#reviews #cancel-comment-reply-link").click(function(){a(this).hide();
a("#respond").slideUp();a(".add-reply-js").show();return!1});themifyScript.variableLightbox&&(m(document),a(document).on("newElements",function(){m(a(".infscr_newElements"))}));a(".product").length&&("undefined"===typeof Themibox?Themify.LoadAsync(themifyScript.theme_url+"/js/themibox.js",function(){Themibox.init()},null,null,function(){return"undefined"!==typeof Themibox}):Themibox.init());l.on("themiboxloaded",function(b){u();if(l.hasClass("single-product")||l.hasClass("post-lightbox"))a(".entry-summary").on("keyup",
