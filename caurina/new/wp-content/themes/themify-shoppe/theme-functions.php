 ...
 * @return bool
 */
function themify_is_archive_rating_stars_enabled() {
    return 'on' == themify_get( 'setting-show_product_rating_stars' );
}


/**
 * Return the rating html
 *
 * @return string
 */
function themify_get_archive_rating_html($product_id){
    ...
    $html .= wc_get_star_rating_html($count);
    $html .= '</div>';
