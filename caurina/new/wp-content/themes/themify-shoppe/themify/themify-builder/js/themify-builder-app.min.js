var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.findInternal=function(g,y,t){g instanceof String&&(g=String(g));for(var v=g.length,r=0;r<v;r++){var p=g[r];if(y.call(t,p,r,g))return{i:r,v:p}}return{i:-1,v:void 0}};$jscomp.defineProperty="function"==typeof Object.defineProperties?Object.defineProperty:function(g,y,t){g!=Array.prototype&&g!=Object.prototype&&(g[y]=t.value)};$jscomp.getGlobal=function(g){return"undefined"!=typeof window&&window===g?g:"undefined"!=typeof global&&null!=global?global:g};
$jscomp.global=$jscomp.getGlobal(this);$jscomp.polyfill=function(g,y,t,v){if(y){t=$jscomp.global;g=g.split(".");for(v=0;v<g.length-1;v++){var r=g[v];r in t||(t[r]={});t=t[r]}g=g[g.length-1];v=t[g];y=y(v);y!=v&&null!=y&&$jscomp.defineProperty(t,g,{configurable:!0,writable:!0,value:y})}};$jscomp.polyfill("Array.prototype.find",function(g){return g?g:function(g,t){return $jscomp.findInternal(this,g,t).v}},"es6-impl","es3");$jscomp.SYMBOL_PREFIX="jscomp_symbol_";
...
(function(g,y,t,v,r,p,l,q){"function"===typeof r.document.ondragstart&&(r.document.ondragstart=v.document.ondragstart=null);var J=g.ui.sortable.prototype._mouseStart,D=p.body.classList.contains("full-section-scrolling");g.ui.sortable.prototype._mouseStart=function(a,b,d){if("mousedown"===a.type&&1===a.which){var e=a.target.classList;if(e.contains("tb_subrow_holder")||e.contains("tb_grid_drag")||e.contains("tb_column_action")&&a.target.parentNode.classList.contains("sub_column")||("row"===c.ActionBar.type||
"subrow"===c.ActionBar.type)&&!e.contains("ti-move")&&null!==a.target.parentNode.closest(".tb_clicked"))return a.stopImmediatePropagation(),a.preventDefault(),!1;this._trigger("beforeStart",a,[this,this._uiHash()])}J.apply(this,[a,b,d])};Element.prototype.closest||(Element.prototype.closest=function(a){var b=null,d=null,c=null,f=this;0===a.indexOf(".")?(b=!0,a=a.replace(".","")):0===a.indexOf("#")?(d=!0,a=a.replace("#","")):c=!0;for(;;){var h=f;h=!0===b&&h.classList.contains(a)||!0===d&&h.id===a||
...
Models:{},Collections:{},Mixins:{},Views:{Modules:{},Rows:{},SubRows:{},Columns:{}},Forms:{},Constructor:{},Utils:{},Instances:{Builder:{}}},C={},A=null;c.builderIndex=0;c.mode="default";c.autoSaveCid=null;c.hasChanged=null;c.editing=!1;c.scrollTo=!1;c.eventName=!1;c.beforeEvent=!1;c.saving=!1;c.activeBreakPoint="desktop";c.zoomMeta={isActive:!1,size:100};c.isPreview=!1;c.clearOnModeChange=null;c.Models.Module=y.Model.extend({defaults:{element_id:null,elType:"module",mod_name:"",mod_settings:{}},
initialize:function(){c.Models.Registry.register(this.cid,this);var a=this.get("element_id");a&&1!==C[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));C[a]=1},toRenderData:function(){return{slug:this.get("mod_name"),name:themifyBuilder.modules[this.get("mod_name")].name,excerpt:this.getExcerpt()}},getExcerpt:function(a){a=a||this.get("mod_settings");return this.limitString(a.content_text||a.content_box||a.plain_text||"",100)},limitString:function(a,b){var c="";""!==a&&(a=this.stripHtml(a).toString(),
c=a.length>b?a.substr(0,b):a);return c},stripHtml:function(a){var b=p.createElement("div");b.innerHTML=a;return b.textContent||b.innerText||""},setData:function(a){c.Utils.clearElementId([a]);a=c.Views.init_module(a);a.model.trigger("custom:change",a)},backendLivePreview:function(){g(".tb_element_cid_"+this.cid).find(".module_excerpt").text(this.getExcerpt())},getPreviewSettings:function(){return _.extend({cid:this.cid},themifyBuilder.modules[this.get("mod_name")].defaults)},getIDattr:function(){return this.get("element_id")?
this.get("element_id"):c.Utils.generateUniqueID()}});c.Models.SubRow=y.Model.extend({defaults:{element_id:null,elType:"subrow",gutter:"gutter-default",column_alignment:D?"col_align_middle":"col_align_top",column_h:"",desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_mobile:"-auto",col_tablet_landscape:"-auto",col_tablet:"-auto",cols:{},styling:{}},initialize:function(){c.Models.Registry.register(this.cid,this);var a=this.get("element_id");a&&1!==C[a]||(a=c.Utils.generateUniqueID(),
this.set({element_id:a},{silent:!0}));C[a]=1},setData:function(a){c.Utils.clearElementId([a]);a=c.Views.init_subrow(a);a.model.trigger("custom:change",a)}});c.Models.Column=y.Model.extend({defaults:{element_id:null,elType:"column",grid_class:"",component_name:"column",modules:{},styling:{}},initialize:function(){c.Models.Registry.register(this.cid,this);var a=this.get("element_id");a&&1!==C[a]||(a=c.Utils.generateUniqueID(),this.set({element_id:a},{silent:!0}));C[a]=1},setData:function(a){c.Utils.clearElementId([a]);
a=c.Views.init_column(a);a.model.trigger("custom:change",a)}});c.Models.Row=y.Model.extend({defaults:{element_id:null,elType:"row",gutter:"gutter-default",column_alignment:D?"col_align_middle":"col_align_top",column_h:"",desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_mobile:"-auto",col_tablet_landscape:"-auto",col_tablet:"-auto",cols:{},styling:{}},initialize:function(){c.Models.Registry.register(this.cid,this);var a=this.get("element_id");a&&1!==C[a]||(a=c.Utils.generateUniqueID(),
this.set({element_id:a},{silent:!0}));C[a]=1},setData:function(a){c.Utils.clearElementId([a]);a=c.Views.init_row(a);a.model.trigger("custom:change",a)}});c.Collections.Rows=y.Collection.extend({model:c.Models.Row});c.Models.Registry={items:{},register:function(a,b){this.items[a]=b},lookup:function(a){return this.items[a]||null},remove:function(a){this.items[a]=null;delete this.items[a]},destroy:function(){for(var a in this.items)this.items[a].destroy();this.items={}}};c.Models.setValue=function(a,
...
g=l.Clipboard.get(f);if(!1===g||!0===k&&"module"===f&&h!==g.mod_name)l.alertWrongPaste();else{c.eventName="row";if(!0===k){var n=ThemifyStyles.getStyleOptions("module"===f?h:f),h="module"===f?"mod_settings":"styling",u=this.getData(d,"column"===f?e.get("component_name"):f),w=function(a){if(-1!==a.indexOf("breakpoint_")||-1!==a.indexOf("_apply_all"))return!0;var b=-1!==a.indexOf("_color")?"color":-1!==a.indexOf("_style")?"style":!1;if(!1!==b){if(b=a.replace("_"+b,"_width"),n[b]!==q&&"border"===n[b].type)return!0}else if(-1!==
a.indexOf("_unit")){if(b=a.replace(/_unit$/ig,"",""),n[b]!==q)return!0}else if(-1!==a.indexOf("_w")){if(b=a.replace(/_w$/ig,"",""),n[b]!==q&&"font_select"===n[b].type)return!0}else if(n[a]!==q&&"radio"===n[a].type)return!0;return!1};u[h]===q&&(u[h]={});for(var z in g[h])n[z]!==q||w(z)?(u[h][z]=g[h][z],n[z]!==q&&(!0===n[z].isFontColor&&g[h][n[z].g+"-gradient"]!==q?u[h][n[z].g+"-gradient"]=g[h][n[z].g+"-gradient"]:(n[z].posId!==q&&g[h][n[z].posId]!==q&&(u[h][n[z].posId]=g[h][n[z].posId]),n[z].repeatId!==
q&&g[h][n[z].repeatId]!==q&&(u[h][n[z].repeatId]=g[h][n[z].repeatId])))):delete g[h][z];g.used_gs!==q&&(u.used_gs=g.used_gs);n=null;g=u;delete g.element_id}"column"===f&&(g.grid_class=c.Utils.filterClass(d.prop("class")),d.hasClass("first")?g.grid_class+=" first":d.hasClass("last")&&(g.grid_class+=" last"),f=d[0].style.width,g.grid_width=f?f.replace("%",""):null,g.component_name=e.get("component_name"));!1===k&&c.Utils.clearElementId([g]);c.hasChanged=!0;c.beforeEvent=l.clone(d);e.setData(g);null!==
c.activeModel&&l.Lightbox.close()}},importExport:function(a,b){var d=b.classList.contains("ti-import")?"import":"export",e=this,f=this.$el,h=this.model,k=h.get("elType"),m=k.charAt(0).toUpperCase()+k.slice(1),n="subrow"===k?"Sub-Row":"sub-column"===k?"Sub-Column":m,m={contructor:!0,loadMethod:"html",data:{component_form:{name:ThemifyConstructor.label[d+"_tab"].replace("%s",m),options:[{id:"tb_data_field",type:"textarea",label:ThemifyConstructor.label.import_label.replace("%s",n),help:ThemifyConstructor.label[d+
"_data"].replace("%s",m),"class":"fullwidth",rows:13}]}}};"import"===d&&(m.save={});l.Lightbox.$lightbox[0].style.display="none";l.Lightbox.open(m,function(){r.document.body.classList.add("tb_standalone_lightbox")},function(){var b=this.$lightbox;b.addClass("tb_import_export_lightbox");this.setStandAlone(a.clientX,a.clientY);if("import"===d)b.find(".builder_save_button").on("click.tb_import",function(a){a.preventDefault();a.stopPropagation();a=b.find("#tb_data_field");a=JSON.parse(a.val());if("column"===
k&&"sub-column"===a.component_name||"sub-column"===k&&"column"===a.component_name)a.component_name=k,a.grid_class=f.closest(".module_column").prop("class");if(a.component_name===q||a.component_name!==k)l.alertWrongPaste();else{var d=a.hasOwnProperty("used_gs")?Object.keys(a.used_gs):[],e=d.length;if(0<e){for(var m=e-1;-1<m;--m){var n=c.GS.findBySlug(d[m]);n&&delete a.used_gs[d[m]];n=null}e&&(c.GS.loadingPosts=!0,g.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_import_gs_posts_ajax",
tb_load_nonce:themifyBuilder.tb_load_nonce,data:a.used_gs},success:function(a){for(var b=Object.keys(a),d=b.length-1;-1<d;--d)c.GS.styles[a[b[d]].id]=a[b[d]],"visual"===c.mode&&(c.liveStylingInstance.setCss(c.GS.styles[a[b[d]].id].data,q,c.GS.styles[a[b[d]].id]["class"]),c.GS.styles[a[b[d]].id].cssLoaded=!0);c.GS.loadingPosts=!1}}))}a=c.Utils.clear(a);c.eventName="row";c.beforeEvent=l.clone(f);c.hasChanged=!0;h.setData(a);l.Lightbox.close()}});else{var m=e.getData(f,k);m.component_name=k;var n=c.GS.findUsedItems(m);
if(!1!==n){for(var x={},p=n.length-1;-1<p;--p){var B=c.GS.styles[n[p]];var K="row"===B.type?B.data[0].styling:"column"===B.type?B.data[0].cols[0].styling:B.data[0].cols[0].modules[0].mod_settings;x[B["class"]]={};x[B["class"]].title=B.title;x[B["class"]]["class"]=B["class"];x[B["class"]].type=B.type;x[B["class"]].data=K}Object.keys(x).length&&(m.used_gs=x)}m=JSON.stringify(m);b.find("#tb_data_field").val(m).on("click",function(){g(this).trigger("focus").trigger("select")})}t.body.one("themify_builder_lightbox_close",
...
this.model.cid)},edit:function(a,b){var d;if(c.isPreview&&q===themifyBuilder.globalStyleData)return!0;if(null===c.activeModel||c.GS.isEmpty(c.activeModel.attributes.gs)){var e=d=c.hasChanged=!1,f=l.Lightbox.$lightbox,h=this.model.get("elType"),k=!1,g="module"===h?this.model.get("mod_name"):h;if(null!==a){var n=b.classList;var u=n.contains("tb_dragger")?b.getAttribute("data-id"):null;if(null!==u&&""===b.getAttribute("data-v"))return;"dblclick"===a.type&&this.model.cid!==c.autoSaveCid&&c.ActionBar.clear();
d=null!==u||n.contains("tb_styling");if(!0===d)this.model.set({styleClicked:!0},{silent:!0}),null!==u&&(k=function(a){var b=n.contains("tb_dragger_padding")?"padding":"margin",d="padding"===b?"p":"m",e=ThemifyConstructor.label[d],f=q;if("module"===h&&(f=a.getElementsByClassName("tb_styling_tab_nav")[0],f!==q)){if(c.EdgeDrag.modules[g]!==q&&c.EdgeDrag.modules[g][b]!==q&&(u=u.replace(/_left|_right|_bottom|_top$/ig,""),c.EdgeDrag.modules[g][b][u]!==q&&(b=c.EdgeDrag.getTabId(ThemifyConstructor.data[g].styling.options.options,
u,d),null!==b))){for(var d=f.getElementsByClassName("tb_tab_wrapper")[0].getElementsByTagName("a"),k=d.length-1;-1<k;--k)if(d[k].getAttribute("href")==="#tb_1_"+b){d[k].click();break}d=null}b=f.getElementsByClassName("current")[0].getElementsByTagName("a")[0].getAttribute("href");f=a.querySelector(b)}f===q&&(f=a);for(var m=f.getElementsByClassName("tb_style_toggle"),k=m.length-1;-1<k;--k)if(m[k].textContent===e){m[k].classList.contains("tb_closed")&&m[k].click();setTimeout(function(){m[k].closest(".simplebar-scroll-content").scrollTop=
m[k].offsetTop;m=null},10);break}});else if(n.contains("tb_visibility_component"))e=!0,this.model.set({visibileClicked:!0},{silent:!0});else if(!0===(n.contains("tb_swap")?!1:"layout-part"===g?!0:t.body.triggerHandler("tb_edit_"+g,[a,this.el,this.model]))&&"visual"===c.mode&&!c.Forms.LayoutPart.id&&("dblclick"===a.type||n.contains("tb_edit"))){c.activeModel=this.model;c.Forms.LayoutPart.edit(this.el);return}}c.GS.isEmpty(this.model.attributes.gs)&&q===themifyBuilder.globalStyleData||(d=!0,this.model.set({styleClicked:!0},
{silent:!0}));null!==c.activeModel&&null!==c.autoSaveCid&&this.model.cid!==c.autoSaveCid&&ThemifyConstructor.saveComponent(!0);c.activeModel=this.model;if(c.autoSaveCid===this.model.cid){var w=null;if(!0===d)w=f.find('a[href="#tb_options_styling"]'),this.model.unset("styleClicked",{silent:!0});else if(!0===e)w=f.find('a[href="#tb_options_visibility"]'),this.model.unset("visibileClicked",{silent:!0});else if("module"===h||"row"===h)w=f.find('a[href="#tb_options_setting"]');null!==w&&0<w.length&&(w[0].click(),
...
if(confirm(themifyBuilder.i18n[k+"DeleteConfirm"])){var m=e.closest(".module_row"),n="row",u="",w={},q=h;"row"===k?(w.pos_cid=m.next(".module_row"),w.pos="before",0===w.pos_cid.length&&(w.pos="after",w.pos_cid=m.prev(".module_row")),n="delete_row",w.pos_cid=w.pos_cid.data("cid")):h=m.data("cid");m=l.clone(m);"row"!==k&&(d=e.closest(".module_subrow"));f.destroy();"row"!==k&&0<d.length&&0===d.find(".active_module").length&&d.addClass("tb_row_empty");"row"!==k&&(u=g(".tb_element_cid_"+h),d=u.closest(".module_row"),
0===d.find(".active_module").length&&d.addClass("tb_row_empty"));c.hasChanged=!0;c.undoManager.push(h,m,u,n,w);null!==c.activeModel&&c.activeModel.cid===q&&l.Lightbox.$lightbox.find(".tb_close_lightbox")[0].click();c.toolbar.pageBreakModule.countModules()}},save:function(a){null!==c.activeModel&&null!==c.autoSaveCid&&ThemifyConstructor.saveComponent(!0);var b=this.model.get("elType"),d={contructor:!0,loadMethod:"html",save:{done:"save"},data:{}},e=this.model.cid;d.data["s"+b]={options:[{id:"item_title_field",
type:"text",label:ThemifyConstructor.label.title},{id:"item_layout_save",type:"checkbox",label:"",options:[{name:"layout_part",value:ThemifyConstructor.label.slayout_part}],new_line:!1,after:"",help:'The Layout Parts are re-usable layout parts that can be included into Builder content or anywhere (<a href="https://themify.me/docs/builder#layout-parts" target="_blank">learn more</a>)'}]};l.Lightbox.$lightbox[0].style.display="none";l.Lightbox.open(d,function(){r.document.body.classList.add("tb_standalone_lightbox")},
...
c.GS.findUsedItems(h);!1!==k&&(f=c.GS.attachCSS(f,k))}f=g.extend(c.Forms.serialize(d),{action:"tb_save_custom_item",item:JSON.stringify(h),css:JSON.stringify(f),tb_load_nonce:themifyBuilder.tb_load_nonce,postid:themifyBuilder.post_ID,type:b});if(k!==q&&!1!==k)for(f.usedGS=[],a=k.length-1;-1<a;--a)f.usedGS.push(c.GS.styles[k[a]]["class"]);var m=f.item_layout_save;g.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:f,success:function(a){h=null;if("success"===a.status){g("#tb_module_panel",
r.document).find(".tb_module_panel_search_text").val("");if(m){c.hasChanged=!0;var d={mod_name:"layout-part",mod_settings:{selected_layout_part:a.post_name}};delete a.status;0<ThemifyConstructor.layoutPart.data.length&&ThemifyConstructor.layoutPart.data.push(a);var f=g(".tb_element_cid_"+e),k=l.clone(f);if("row"===b){d=c.Views.init_row({cols:[{grid_class:"col-full first last",element_id:c.Utils.generateUniqueID(),modules:[d]}]});var n=d.view.render();d=c.Models.Registry.lookup(n.$el.find(".active_module").data("cid"))}else d=
c.Views.init_module(d),n=d.view.render(),d=d.model;f.replaceWith(n.el);if("visual"===c.mode)g(p).ajaxComplete(function F(a,d,e){-1!==e.data.indexOf("tb_load_module_partial",3)&&(g(this).off("ajaxComplete",F),u="row"===b?c.liveStylingInstance.$liveStyledElmt.closest(".module_row"):c.liveStylingInstance.$liveStyledElmt,c.undoManager.push(n.$el.data("cid"),k,u,"row"))}),d.trigger("custom:preview:refresh",d.get("mod_settings"));else{var u=n.el;c.Mixins.Builder.updateModuleSort(n.$el);c.undoManager.push(n.$el.data("cid"),
k,u,"row")}}f=g(".tb_library_item_list");a=c.toolbar.libraryItems.template([a]);"visual"===c.mode&&(f=f.add(c.toolbar.$el.find(".tb_library_item_list")));f=f.get();d=0;for(var w=f.length;d<w;++d){var q=f[d].getElementsByClassName("simplebar-content");0<q.length?q[0].insertAdjacentHTML("afterbegin",a):f[d].insertAdjacentHTML("afterbegin",a);f[d].previousElementSibling.getElementsByClassName("current")[0].click()}c.toolbar.libraryItems.bindEvents(!0);l.showLoader("hide");l.Lightbox.close()}else alert(a.msg)}})}};
...
c.Views.init_subrow({cols:a[0].cols})).view.render().$el;if(d||b[0].parentNode.classList.contains("tb_holder")||b[0].parentNode.parentNode.classList.contains("tb_holder"))b[0].parentNode.replaceChild(h[0],b[0]),h[0].className+=" tb_element_selected",c.ActionBar.type="subrow";else{var g=b.next(".tb_holder");0<g.length?g.prepend(h):(g=b.prev(".tb_holder"),g.append(h))}if(d){e=h.next(".module_row");var m=!0;0===e.length&&(m=!1,e=h.prev(".module_row"));e=e.data("cid");f="grid_sort"}c.Utils.setCompactMode(h[0].getElementsByClassName("module_column"));
c.Mixins.Builder.update(h);b.remove();c.hasChanged=!0;g=h.closest(".module_row");d||g.removeClass("tb_row_empty");g.find(".tb_row_grid").remove();c.Utils.scrollToDropped(h[0]);c.undoManager.push(g.data("cid"),e,g,f,{next:m})}else b.remove()},rowDrop:function(a,b,d,e){function f(){var a=b.prev(".module_row");if(0===a.length){var d="visual"===c.mode?b.closest(".themify_builder_content").data("postid"):null;a=!1}else a=a.data("cid");b[0].innerHTML="";c.ActionBar.type="row";b[0].parentNode.replaceChild(g,
b[0]);c.hasChanged=!0;c.Instances.Builder[c.builderIndex].removeLayoutButton();c.undoManager.push("","","","predesign",{prev:a,rows:m,bid:d});a=0;for(d=m.length;a<d;++a){var e=m[a][0].getElementsByClassName("module_column");0===a&&m[a][0].classList.add("tb_element_selected");c.Utils.setCompactMode(e);c.Mixins.Builder.update(m[a])}c.Utils.scrollToDropped(m[0][0]);l.showLoader("hide")}c.ActionBar.clear();var h=function(a){for(var b in a)if(a[b].styling&&0<Object.keys(a[b].styling).length||a[b].modules&&
0<Object.keys(a[b].modules).length)return!0;return!1},g=p.createDocumentFragment(),m=[],n=[];e||c.Utils.clearLastEmptyRow(a);e=0;for(var u=a.length;e<u;++e)if(!0===d||a[e].styling&&0<Object.keys(a[e].styling).length||a[e].cols&&h(a[e].cols)){var w=c.Views.init_row(a[e]);if(!1!==w){w=w.view.render();g.appendChild(w.el);if("visual"===c.mode){var q=w.el.querySelectorAll("[data-cid]");n[w.el.dataset.cid]=1;e=0;for(u=q.length;e<u;++e)n[q[e].dataset.cid]=1}m.push(w.$el)}}"visual"===c.mode?(c.bootstrap(n,
f),n=null):f()},moduleDrop:function(a,b,d){function e(e){function f(e){k||g.model.set({is_new:1},{silent:!0});e=!0===e?g.model.getPreviewSettings():g.model.get("mod_settings");b?b.hasClass("tb_module_front")?b.after(m.el):b.append(m.el):a.replaceWith(m.el);k?c.activeModel=g.model:g.model.trigger("edit",null);c.hasChanged=!0;if("visual"===c.mode&&1<=Object.keys(e).length&&"layout-part"!==g.model.get("mod_name")){var f=e.cid;if("part"===h||"ajax"===a.data("type")){var n=!0;g.model.trigger("custom:preview:refresh",
e)}else"module"!==h?g.model.trigger("custom:preview:live",e):c.Utils.loadContentJs(m.$el,"module")}k&&(n&&(n=g.view.$el.find(".tb_preview_component").detach(),g.view.$el.prepend(n)),d&&(f=m.$el.closest(".module_row"),f.removeClass("tb_row_empty").find(".tb_module_dragging_helper").remove(),m.$el.closest(".module_subrow").removeClass("tb_row_empty"),c.undoManager.push(f.data("cid"),d,f,"row"),f=f.data("cid"),c.Instances.Builder[c.builderIndex].removeLayoutButton(),c.activeModel=null));c.Utils.scrollToDropped(null,
f)}var g=c.Views.init_module(e,!0),m=g.view.render();"visual"===c.mode&&k?(e=[],e[g.model.cid]=1,c.bootstrap(e,f)):f(!0);return m}c.ActionBar.clear();if(a[0].classList.contains("tb_row_grid"))this.subRowDrop(a.data("slug"),a);else{var f={mod_name:a.data("module-slug")},h=a.data("type"),k="part"===h||"module"===h;if(k)c.toolbar.libraryItems.get(a.data("id"),h,e);else return e(f);"visual"!==c.mode&&g(".themify-wp-editor-holder").addClass("themify-active-holder")}},toJSON:function(a){var b=[];a=a.children;
...
d=e.closest(".module_row"),d.toggleClass("tb_row_empty",0===d.find(".active_module").length),d=null;else if("row_sort"===f)b=d.cid,k=d.data[a?"bnext":"anext"],d=g(".tb_element_cid_"+d.data[a?"before":"after"]),h=g(".tb_element_cid_"+b),e=l.clone(h),h.remove(),h=null,this.set(e),k?d.before(e):d.after(e),this.doScroll(e);else if("save"===f){b=d.cid;var f=c.Models.Registry.lookup(b),m="module"===f.get("elType"),n=m?"mod_settings":"styling";if(m&&d.data.column)a?(d=g(".tb_element_cid_"+b).closest(".module_row"),
b=!1,this.doScroll(h).remove()):(b=d.data.column.data("cid"),e=l.clone(d.data.column),h=g(".tb_element_cid_"+b),this.doScroll(h),this.set(e),h.replaceWith(e),d=e.closest(".module_row")),d.toggleClass("tb_row_empty",0===d.find(".active_module").length),d=null;else{this.doScroll(h);m={};a?(e=l.clone(d.before),m[n]=d.data.bsettings):(e=l.clone(d.after),m[n]=d.data.asettings);if("visual"===c.mode){d=g.extend(!0,{},d.data.styles);for(var u in d)for(k in n=ThemifyStyles.getSheet(u),n=n.cssRules?n.cssRules:
n.rules,d[u])if(n[k])for(var w in d[u][k])n[k].style["backgroundClip"===w||"background-clip"===w?"WebkitBackgroundClip":w]=a?d[u][k][w].b:d[u][k][w].a}f.set(m,{silent:!0});m=null;this.set(e);h.replaceWith(e)}}else if("predesign"===f)if(h=d.data.rows,a)for(this.doScroll(g(".tb_element_cid_"+h[0].data("cid"))),k=0,u=h.length;k<u;++k)g(".tb_element_cid_"+h[k].data("cid")).remove();else{w=p.createDocumentFragment();e=[];k=0;for(u=h.length;k<u;++k)f=l.clone(h[k]),w.appendChild(f[0]),e.push(f);!1!==d.data.prev?
this.doScroll(g(".tb_element_cid_"+d.data.prev)).after(w):this.doScroll("visual"===c.mode?g("#themify_builder_content-"+d.data.bid):g("#tb_row_wrapper")).prepend(w);k=0;for(u=e.length;k<u;++k)this.set(e[k]),c.Mixins.Builder.update(e[k])}else if("import"===f){k=g('[data-postid="'+d.data.bid+'"]');d=a?d.data.before:d.data.after;var z=this;d=l.clone(d);k.children().remove();k.prepend(d);d.each(function(){z.set(g(this))})}else"grid_sort"===f&&(a?g(".tb_element_cid_"+d.cid).remove():(k=g(".tb_element_cid_"+
...
g=p.createElement("strong"),m=p.createElement("a");e.className="tb_module_outer tb-module-"+d;e.dataset.categories=themifyBuilder.modules[d].category;themifyBuilder.modules[d].favorite&&(e.className+=" favorited");f.className="tb_module tb-module-type-"+d;h.className="tb_favorite ti-star tb_disable_sorting";g.className="module_name";g.textContent=themifyBuilder.modules[d].name;m.href="#";m.className="add_module_btn tb_disable_sorting";m.dataset.type="module";m.title=themifyBuilder.i18n.add_module;
f.dataset.moduleSlug=d;themifyBuilder.modules[d].type&&(f.dataset.type=themifyBuilder.modules[d].type);f.appendChild(h);f.appendChild(g);f.appendChild(m);e.appendChild(f);f=themifyBuilder.modules[d].favorite?["favorite"]:themifyBuilder.modules[d].category;h=0;for(g=f.length;h<g;++h)b[f[h]]===q&&(b[f[h]]=p.createDocumentFragment()),b[f[h]].appendChild(e.cloneNode(!0))}f=this.el.getElementsByClassName("tb_module_category_content");for(d=f.length-1;-1<d;--d)if(e=f[d].getAttribute("data-category"))q!==
...
(b[d].classList.remove("tb_ui_dropdown_items"),b[d].parentNode.classList.remove("tb_compact_tabs"))},resize:function(){for(var a=this.el.getElementsByClassName("tb_modules_panel_wrap")[0],b=this,d,c,f,h,k=a.getElementsByClassName("tb_resizable"),m,n,u=null,l=function(e){var g=d+h-e.clientX,k=null;if("w"===n||"sw"===n||"nw"===n){var l=a.style.width;k=parseInt(a.style.left)+parseInt(l)-g}if("w"!==n){if("y"===n||"-y"===n||"sw"===n||"se"===n||"nw"===n||"ne"===n)if(l="-y"===n||"ne"===n||"nw"===n?c+f-e.clientY:
f+e.clientY-c,50<=l&&l<=u){if("-y"===n||"ne"===n||"nw"===n)a.style.top=parseInt(a.style.top)+parseInt(a.style.height)-l+"px";a.style.height=l+"px"}"sw"!==n&&"nw"!==n&&(g=h+e.clientX-d)}if("y"!==n&&"-y"!==n){if(500<g||120>g)l=g,g=120>g?120:500,null!==k&&(k=k+l-g);null!==k&&(a.style.left=k+"px");a.style.width=g+"px";e=b.getPanelClass(g);m!==e&&(m&&a.classList.remove(m),a.classList.add(e),m=e,b._setResponsiveTabs(e))}},q=function(){r.document.body.classList.remove("tb_start_animate");r.document.body.classList.remove("tb_panel_resize");
r.document.removeEventListener("mousemove",l,{passive:!0});r.document.removeEventListener("mouseup",q,{passive:!0});d=h=n=m=null;b.updateStorage()},p=k.length-1;-1<p;--p)k[p].addEventListener("mousedown",function(b){1===b.which&&(r.document.body.classList.add("tb_start_animate"),r.document.body.classList.add("tb_panel_resize"),n=this.dataset.axis,d=b.clientX,c=b.clientY,u=g(v).height()-50,f=parseInt(g(a).outerHeight(),10),h=parseInt(g(a).outerWidth(),10),r.document.addEventListener("mousemove",l,
...
function h(){a();var b=m.find(".layout_preview_list");n.show().find("li").on("click",function(a){a.preventDefault();a.stopPropagation();this.classList.contains("current")||(a=b,this.classList.contains("all")||(b.hide(),a=b.filter("[data-category"+(""!==themifyBuilder.paths.layouts_index?"*":"")+'="'+g(this).text()+'"]')),a.show(),u(a),g(this).addClass("current").siblings().removeClass("current"),n.parent().find(".tb_ui_dropdown_label").html(g(this).text()));c.Utils.hideOnClick(n)});k.find("#tb_layout_search").on("keyup",
function(){var a=g.trim(g(this).val()),d=b;""!==a&&(d=n.find("li.all"),d[0].classList.contains("current")||d.click(),b.hide(),d=b.find(".layout_title:contains("+a+")").closest(".layout_preview_list"));d.show();u(d)})[0].focus();new SimpleBar(k[0]);new SimpleBar(n[0]);t.body.one("themify_builder_lightbox_close.loadLayout",function(){k.off("click.loadLayout")[0].classList.remove("tb_predesigned_lightbox");m.find("#tb_layout_search").off("keyup");m=k=null;d.classList.remove("tb_load_layout_active");
d.classList.remove("tb_standalone_lightbox");e.removeClass("tb_current_menu_selected")})}var k=this.$lightbox,m=k.find("#tb_tabs_pre-designed");if(0===m.length)d.classList.remove("tb_load_layout_active"),d.classList.remove("tb_standalone_lightbox"),e.removeClass("tb_current_menu_selected"),a();else{k[0].classList.add("tb_predesigned_lightbox");this.setStandAlone(r.innerWidth/2,(r.document.documentElement.clientHeight-k.height())/2,!0);var n=m.find(".tb_ui_dropdown_items"),u=function(a){a.each(function(a){0===
a%4?this.classList.add("layout-column-break"):this.classList.remove("layout-column-break")})};if(b.layoutsList)h();else{var w=function(a,d){for(var c,e,f={},l=p.createDocumentFragment(),w=p.createDocumentFragment(),r=0,z=a.length;r<z;++r){c=p.createElement("li");var x=p.createElement("div"),t=p.createElement("div"),v=p.createElement("img"),y=p.createElement("div"),A=p.createElement("div"),E=p.createElement("a"),I=p.createElement("i");c.className="layout_preview_list";c.dataset.category=a[r].category;
x.className="layout_preview";x.dataset.id=a[r].id;x.dataset.slug=a[r].slug;t.className="thumbnail";v.src=a[r].thumbnail;v.alt=a[r].title;v.title=a[r].title;y.className="layout_action";A.className="layout_title";A.textContent=a[r].title;E.className="layout-preview-link themify_lightbox";E.href=a[r].url;E.target="_blank";E.title=themifyBuilder.i18n.preview;I.className="ti-search";E.appendChild(I);y.appendChild(A);y.appendChild(E);t.appendChild(v);x.appendChild(t);x.appendChild(y);c.appendChild(x);l.appendChild(c);
if(a[r].category)for(x=String(a[r].category).split(","),t=0,v=x.length;t<v;++t)""!==x[t]&&1!==f[x[t]]&&(c=p.createElement("li"),c.textContent=x[t],w.appendChild(c),f[x[t]]=1,x[t]===d&&(e=c))}n[0].appendChild(w);m[0].getElementsByClassName("tb_layout_lists")[0].appendChild(l);l=w=f=null;k.find(".tb_tab").each(function(){u(g(this).find(".layout_preview_list"))});b.layoutsList=k[0].getElementsByClassName("tb_options_tab_wrapper")[0].cloneNode(!0);h();q!==e&&e.click()};g.ajax({type:"POST",url:themifyBuilder.ajaxurl,
dataType:"json",data:{action:"tb_load_predesigned_layouts",nonce:themifyBuilder.tb_load_nonce,src:themifyBuilder.paths.layouts_index,id:themifyBuilder.post_ID},beforeSend:function(){setTimeout(function(){l.showLoader("show")},500)},success:function(a){var b=JSON.parse(a.data);if(""===themifyBuilder.paths.layouts_index){var d=Object.keys(b);c.layouts_selected={};for(var e=d.length-1;-1<e;--e)c.layouts_selected[b[d[e]].slug]=b[d[e]].data}w(b,a.selected);l.showLoader("spinhide")},error:function(){l.LiteLightbox.alert(g("#tb_load_layout_error",
m).show().text());l.showLoader("spinhide")}})}}})},saveLayout:function(a){a.preventDefault();a.stopPropagation();var b={contructor:!0,loadMethod:"html",save:{},data:{save_as_layout:{options:[{id:"layout_title_field",type:"text",label:ThemifyConstructor.label.title},{id:"layout_img_field",type:"image",label:ThemifyConstructor.label.image_preview},{id:"layout_img_field_id",type:"hidden"},{id:"postid",type:"hidden",value:themifyBuilder.post_ID}]}}},d=g(a.currentTarget.closest("ul"));d.addClass("tb_current_menu_selected");
...
var m=f.value=A;f.addEventListener("input",function(){A=this.value.trim();if("visual"===c.mode){var a=p.getElementById("tb_custom_css_tmp");null===a&&(a=p.createElement("style"),a.type="text/css",a.id="tb_custom_css_tmp",p.head.appendChild(a));a.innerHTML=A}});h.addEventListener("click",function(){if(m!==f.value.trim()){var a=p.querySelector("#tb_custom_css_tmp");A=m;f.value=m;a&&(a.innerHTML=m)}});g.addEventListener("click",function(){m=f.value.trim();A=f.value.trim()});b.addClass("tb_custom_css_lightbox").find(".builder_save_button").one("click",
function(a){a.stopImmediatePropagation();a.preventDefault();l.Lightbox.close()});this.setStandAlone(a.clientX,a.clientY);t.body.one("themify_builder_lightbox_close",function(){A||d.classList.add("tb_tooltip_active");d=null;r.document.body.classList.remove("tb_standalone_lightbox")})})},Revisions:{init:function(){c.toolbar.$el.find(".tb_revision").on("click",this.revision.bind(this))},revision:function(a){a.preventDefault();a.stopPropagation();a.currentTarget.classList.contains("tb_save_revision")?
...
d.load.bind(d))})},masonry:function(a){for(var b=a.querySelectorAll('.predesigned_row:not([data-masonry="done"])'),d=b.length,c=0;c<d;c++){var f=b[c],h=parseInt(v.top.getComputedStyle(a).getPropertyValue("grid-row-gap")),g=parseInt(v.top.getComputedStyle(a).getPropertyValue("grid-auto-rows"));if(!isNaN(h)&&!isNaN(g)){var m=f.getElementsByClassName("tb_predesigned_rows_image")[0].getBoundingClientRect().height+f.getElementsByClassName("tb_predesigned_rows_title")[0].getBoundingClientRect().height,
h=Math.ceil((m+h)/(g+h));f.style.gridRowEnd="span "+h;5<h&&(f.dataset.masonry="done")}}},loadItems:function(a){this.loadingItems=!0;var b=this.currentCategory,d=p.createDocumentFragment();if(!0===this.categories.All.isLoaded||!0===this.categories[b].isLoaded)return this.loadingItems=!1,d;for(var c=0,f=Object.keys(this.items),h=f.length,g=0;g<h&&!(10<=c&&q==a);g++){var m=this.items[f[g]],n=""!==a?new RegExp(a,"i"):!1;if(n&&n.test(m.title)){var u=m.category.split(",");if("All"===b||-1!==u.indexOf(b)){delete this.items[f[g]];
for(var n="",l=0,r=u.length;l<r;++l)n+=this.categories[u[l]].hash;var u=p.createElement("div"),l=p.createElement("figure"),r=p.createElement("div"),x=new Image,t=p.createElement("a");u.className="predesigned_row "+n;u.setAttribute("data-slug",m.slug);l.className="tb_predesigned_rows_image";r.className="tb_predesigned_rows_title";r.textContent=x.alt=x.title=m.title;x.src=m.thumbnail===q||""===m.thumbnail?"https://placeholdit.imgix.net/~text?txtsize=24&txt="+encodeURI(m.title)+"&w=181&h=77":m.thumbnail;
x.width=500;x.height=300;t.href="#";t.className="add_module_btn tb_disable_sorting";t.dataset.type="predesigned";l.appendChild(x);l.appendChild(t);u.appendChild(l);u.appendChild(r);d.appendChild(u);c++}}}this.categories[b].isLoaded=10>c&&q===a;return d},setData:function(a){this.items=a;a=null;var b=[];a=p.createDocumentFragment();for(var d=0,e=this.items.length;d<e;++d)for(var f=this.items[d].category.split(","),h=0,k=f.length;h<k;++h){var m=t.hash(f[h]);-1===b.indexOf(f[h])&&(b.push(f[h]),this.categories[f[h]]=
{hash:"tb"+m})}b.sort();d=0;for(e=b.length;d<e;++d)f=p.createElement("li"),f.setAttribute("data-slug",t.hash(b[d])),f.textContent=b[d],a.appendChild(f);var b=g(".tb_module_panel_container .tb_ui_dropdown .tb_ui_dropdown_items"),e=g(".tb_predesigned_rows_container"),n=this;"visual"===c.mode&&(e=e.add(c.toolbar.$el.find(".tb_predesigned_rows_container")),b=b.add(c.toolbar.$el.find(".tb_module_panel_container .tb_ui_dropdown .tb_ui_dropdown_items")));b=b.get();e=e.get();f=this.loadItems();for(d=b.length-
1;-1<d;--d)b[d].appendChild(a.cloneNode(!0)),e[d].appendChild(f.cloneNode(!0)),h=e[d].getElementsByTagName("img"),0<h.length?(h=h[h.length-1],g(h).one("load",function(){n.initCallback(g(this).closest(".tb_predesigned_rows_container")[0],!0)})):n.initCallback(e[d],!0);t.body.on("click",".tb_module_panel_container .tb_ui_dropdown_items li",this.filter.bind(this));if("visual"===c.mode)g("body",r.document).on("click",".tb_module_panel_container .tb_ui_dropdown_items li",this.filter.bind(this))},initCallback:function(a,
...
d.clicked||(d.clicked=c.Instances.Builder[c.builderIndex].newRowAvailable(1,!0),b=!0);if("module"===k){var m=d.clicked.hasClass("tb_module_btn_plus")?d.clicked.parent():d.clicked.closest(".module_column").find(".tb_holder").last();c.toolbar.Panel.add_module(a,m)}else if("row"===k)m=d.clicked.hasClass("tb_module_btn_plus")?d.clicked.parent():d.clicked.closest(".module_column").find(".tb_holder").first(),c.toolbar.Panel.click_add_sub_row(a,m);else if(e.contains("js-tb_module_panel_acc"))c.toolbar.toggleAccordion(a);
else if("predesigned"===k||"page_break"===k)m=d.clicked.closest(".module_row"),"page_break"===k?c.toolbar.Panel.click_add_page_break(a,m):c.toolbar.preDesignedRows.get(g(a.currentTarget).closest(".predesigned_row").data("slug"),function(a){c.Mixins.Builder.rowDrop(a,b?m:g("<div>").insertAfter(m),!0)});e.contains("js-tb_module_panel_acc")||d.hide(!0)}).on("keyup",".tb_module_panel_search_text",this.search.bind(this)).on("click",".tb_clear_input",this.clear)},run:function(){var a=c.toolbar.$el.find("#tb_module_panel");
...
180)));e.addClass("tb_panel_dropdown_openend");this.clicked.addClass("clicked");"desktop"===c.activeBreakPoint&&setTimeout(function(){this.btn.find(".tb_module_panel_search_text").focus()}.bind(this),50);this.hide();c.ActionBar.clear();null!==c.activeModel&&(e=l.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0],e!==q&&e.click());var e=k.getElementsByTagName("img"),m=k.getElementsByClassName("simplebar-content");0<e.length?(e=e[e.length-1],g(e).one("load",function(){c.toolbar.preDesignedRows.masonry(m.length?
m[0]:k)})):c.toolbar.preDesignedRows.masonry(m.length?m[0]:k)},resize:function(){null!==this.btn&&c.Utils.addViewPortClass(this.btn[0])},hide:function(a){function b(){if(!0===a||!d.btn.is(":hover")){var e=t.body;null!==d.btn&&(d.btn.hide().css("width",""),d.clicked&&d.clicked[0].classList.remove("clicked"),d.clicked=null);g(p).off("click",b);g(r.document).off("click",b);"visual"===c.mode&&(e=e.add(g("body",r.document)),"desktop"!==c.activeBreakPoint&&(g("body",r.document).height(p.body.scrollHeight),
...
b.dataset.height],a.target=d,a.currentTarget=d,this.breakpointSwitcher(a))},breakpointSwitcher:function(a){a.preventDefault();a.stopPropagation();var b=this,d="desktop",e=a.currentTarget,f=g("body",r.document),h="visual"===c.mode&&c.iframe[0].classList.contains("tb_resizing_start"),k=c.activeBreakPoint,m=function(){b.responsive_grids(d,k);var a=function(){c.Utils.setCompactMode(p.getElementsByClassName("module_column"));c.toolbar.el.getElementsByClassName("tb_compact_switcher")[0].getElementsByTagName("i")[0].className=
e.getElementsByTagName("i")[0].className;f.removeClass("tb_start_animate").toggleClass("tb_responsive_mode","desktop"!==d).removeClass("builder-breakpoint-"+k).addClass("builder-breakpoint-"+d);t.body.triggerHandler("themify_builder_change_mode",[k,d]);"visual"===c.mode&&(c.iframe[0].style.willChange="",setTimeout(function(){r.document.body.style.height="desktop"!==d?p.body.scrollHeight+"px":"";!h&&c.scrollTo&&(g(v).add(r.document).scrollTop(c.scrollTo.offset().top),c.scrollTo=!1)},150));c.ActionBar.disable=
...
d)){var n="desktop"!==d?q!==a.tb_device?"tablet_landscape"===d?a.tb_device[1]:a.tb_device[0]:c.Utils.getBPWidth(d)-1:"";if(k===d&&a.originalEvent!==q&&(n?n+"px":n)===c.iframe[0].style.width)return!1;c.ActionBar.disable=!0;if("visual"===c.mode){null===c.clearOnModeChange&&c.ActionBar.clear();if(!h&&!c.isPreview){var u=c.Instances.Builder[0].el.children;var w=[];for(var z=v.innerHeight,x=function(a){if(null!==a&&a!==q){var b=a.getBoundingClientRect();if(0>b.bottom&&0>b.top||b.top>z)a.style.display=
"none",w.push(a)}},H=u.length-1;-1<H;--H)x(u[H]);x(p.getElementById("headerwrap"));x(p.getElementById("footerwrap"));u=z=null}f=f.add(t.body)}c.activeBreakPoint=d;f.addClass("tb_start_animate");if("visual"===c.mode){c.iframe[0].style.willChange="width";u=r.document.getElementsByClassName("tb_toolbar_zoom_menu")[0];u.classList.remove("tb_toolbar_zoom_active");u.getElementsByClassName("tb_toolbar_zoom_menu_toggle")[0].dataset.zoom=100;"tablet_landscape"===d&&l.Lightbox.dockMode.get()&&(u=g(".tb_workspace_container",
r.document).width(),u<n&&(n=u));if(c.isPreview&&(u={tablet_landscape:[1024,768],tablet:[768,1024],mobile:[375,667]},u[d]!==q)){n=q==a.tb_device?u[d][0]:"tablet_landscape"===d?a.tb_device[1]:a.tb_device[0];var B=q==a.tb_device?u[d][1]:"tablet_landscape"===d?a.tb_device[0]:a.tb_device[1]}c.iframe[0].parentNode.classList.remove("tb_zoom_bg");h?m():(r.document.body.offsetHeight,c.iframe.one(c.Utils.transitionPrefix(),function(){if(!c.isPreview){for(var a=w.length-1;-1<a;--a)w[a].style.display="";w=null}setTimeout(m,
10)}),c.iframe[0].style.width=n?n+"px":n,c.iframe[0].style.height=c.isPreview?B?B+"px":B:"")}else m()}},iframeScroll:function(a){var b=g(r.document);b.off("scroll.themifybuilderresponsive");if(a)b.on("scroll.themifybuilderresponsive",function(){v.scrollTo(0,g(this).scrollTop())})},responsive_grids:function(a,b){for(var d=p.querySelectorAll(".row_inner,.subrow_inner"),c="desktop"===a,f=c||"desktop"===b,h=d.length-1;-1<h;--h){var k=d[h].getAttribute("data-basecol");if(null!==k){var m=d[h].children,
n=d[h].dataset["col_"+a],l=m[0],w=m[m.length-1];if(!c){if("desktop"!==b){d[h].classList.remove("tb_3col");var r=d[h].getAttribute("data-col_"+b);r&&d[h].classList.remove(g.trim(r.replace("tb_3col","").replace("mobile","column").replace("tablet","column")))}if(n&&"-auto"!==n&&n!==a+"-auto"){if(n=d[h].getAttribute("data-col_"+a))for(d[h].classList.add("tb_grid_classes"),d[h].classList.add("col-count-"+k),n=n.split(" "),k=0,r=n.length;k<r;++k)d[h].classList.add(g.trim(n[k].replace("mobile","column").replace("tablet",
"column")))}else d[h].classList.remove("tb_grid_classes"),d[h].classList.remove("col-count-"+k)}if(f)for(k=0,n=m.length;k<n;++k)r=g(m[k]).data("w"),r!==q&&(m[k].style.width=c?r+"%":"");"rtl"===d[h].getAttribute("data-"+a+"_dir")?(l.classList.remove("first"),l.classList.add("last"),w.classList.remove("last"),w.classList.add("first"),d[h].classList.add("direction-rtl")):(l.classList.remove("last"),l.classList.add("first"),w.classList.remove("first"),w.classList.add("last"),d[h].classList.remove("direction-rtl"))}}},
...
g(this),b=a.closest(".tb_module_outer"),d=a.parent().data("module-slug");g.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_module_favorite",module_name:d,module_state:+!b.hasClass("favorited")},beforeSend:function(a){function e(a,b){function f(){var f;if(a.length){b&&(f=0<a.closest("#tb_module_panel_dropdown").length?c.toolbar.$el:g("#tb_module_panel_dropdown"));a.removeAttr("style");var h=a.data("categories").split(","),k=a.closest(".tb_module_panel_modules_wrap"),m=
k.find('.tb_module_category_content[data-category="favorite"]');if(a.hasClass("favorited")){for(var n=h.length-1;0<=n;n--){var l=k.find('.tb_module_category_content[data-category="'+h[n]+'"]').parent();l.find(".tb_module_outer.tb-module-"+d).css({opacity:0,transform:"scale(0.5)"}).remove();l.find(".tb_module_outer").length||l.css({display:"none"})}m.parent().css({display:"block"});a.clone().css({opacity:0,transform:"scale(0.5)"}).appendTo(m).css({opacity:1,transform:"scale(1)"})}else for(n=h.length-
1;0<=n;n--){l=k.find('.tb_module_category_content[data-category="'+h[n]+'"]');var q=a.clone().css({opacity:0,transform:"scale(0.5)"}).appendTo(l);l.parent().css({display:"block"});q.css({opacity:1,transform:"scale(1)"})}b&&e(f.find(".tb-module-type-"+d).closest(".tb_module_outer"),!1);a.remove();m.find(".tb_module_outer").length||m.parent().css({display:"none"})}}if(a.length&&!a.is(":visible"))a.toggleClass("favorited"),f();else a.css({opacity:0,transform:"scale(0.5)"}).one(h,function(){a.toggleClass("favorited").one(h,
...
[];var k=a.getElementsByClassName("tb-checkbox");var m=f.contains("tb_switcher");for(var f=0,n=k.length;f<n;++f)!0!==m&&!0!==k[f].checked||""===k[f].value||e.push(k[f].value);e=0<e.length?e.join("|"):m?"":!1}else if(f.contains("themify-layout-icon"))e=a.getElementsByClassName("selected")[0],e=e!==q?e.id:"";else if(f.contains("tb_search_input"))e=a.getAttribute("data-value"),f.contains("query_category_single")&&(f=a.closest(".tb_input").getElementsByClassName("query_category_multiple")[0],f=f===q?
"":f.value.trim(),e=""!==f?f+"|"+(-1!==f.indexOf(",")?"multiple":"single"):e+"|single");else if(f.contains("tb_radio_input_container")){k=a.getElementsByTagName("input");m=null;f=0;for(n=k.length;f<n;++f)if(!0===k[f].checked){m=k[f];break}null===m||"desktop"!==c.activeBreakPoint&&m.classList.contains("responsive_disable")||(e=m.value)}else if(f.contains("tb_search_container"))e=a.previousElementSibling.dataset.value;else if(f.contains("tb_row_js_wrapper")){e=[];var l=a.getElementsByClassName("tb_repeatable_field_content");
f=0;for(n=l.length;f<n;++f){k=l[f].getElementsByClassName("tb_lb_option_child");e[f]={};var p=0;for(d=k.length;p<d;++p)(m=this.parseSettings(k[p],!0))&&(e[f][m.id]=m.v)}}else if(f.contains("module-widget-form-container"))e=g(a).find(":input").themifySerializeObject();else if(f.contains("tb_widget_select"))e=a.getElementsByClassName("selected")[0],e=e!==q?e.dataset.value:"";else if(f.contains("tb_sort_fields_parent")){k=a.children;e=[];f=0;for(n=k.length;f<n;++f)if(m=k[f].getAttribute("data-type")){p=
k[f].getElementsByClassName("tb_sort_field_dropdown")[0];m={type:m,id:k[f].getAttribute("data-id")};if(p!==q)for(m.val={},l=p.getElementsByClassName("tb_lb_sort_child"),p=l.length-1;-1<p;--p)(d=this.parseSettings(l[p],!0))&&(m.val[d.id]=d.v);else d=k[f].getElementsByTagName("input")[0],p=d.value,""!==p&&(m.val=JSON.parse(p));e.push(m)}0===e.length&&(e="")}else if(f.contains("tb_toggleable_fields"))for(k=a.children,e={},f=0,n=k.length;f<n;++f){if(l=k[f].getAttribute("data-id"))d=k[f].getElementsByTagName("input")[0],
p=k[f].getElementsByClassName("tb_toggleable_fields_options")[0],m={on:k[f].getElementsByClassName("tb_switcher")[0].getElementsByClassName("toggle_switch")[0].value},p!==q?m.val=this.serialize(p,null,!0):(p=d.value,""!==p&&(m.val=JSON.parse(p))),e[l]=m}else e=a.value,""!==e&&(f=a.getAttribute("data-opacity"),null!==f&&""!==f&&1!=f&&"0.99"!=f&&(e+="_"+f));if(e===q||null===e)e="";return{id:h,v:e}},serialize:function(a,b,d){d=d||!1;var c={};a="object"===typeof a?a:r.document.getElementById(a);if(null!==
a){a=a.getElementsByClassName(d?"tb_lb_option_child":"tb_lb_option");for(var f=a.length-1;-1<f;--f){var h=this.parseSettings(a[f],d);!1===h||!0!==b&&""===h.v||(c[h.id]=h.v)}}return c},LayoutPart:{cache:[],undo:null,old_id:null,isReload:null,id:null,init:!1,html:null,el:null,options:null,isSaved:null,scrollTo:function(a,b){c.scrollTo=c.Forms.LayoutPart.el},edit:function(a){function b(a){c.ActionBar.clear();p.getElementById("themify_builder_content-"+themifyBuilder.post_ID).insertAdjacentHTML("afterbegin",
'<div class="tb_overlay"></div>');f.addClass("tb_active_layout_part").closest(".row_inner").find(".active_module").each(function(){this.classList.contains("tb_active_layout_part")||this.insertAdjacentHTML("afterbegin",'<div class="tb_overlay"></div>')});var b="themify_builder_content-"+e.id;e.html=f[0].innerHTML;themifyBuilder.post_ID=ThemifyStyles.builder_id=e.id;f[0].insertAdjacentHTML("afterbegin",k.replace("#postID#",e.id));g("."+b).each(function(){g(this).closest(".active_module").find(".themify-builder-generated-css").first().prop("disabled",
!0)});f.removeClass("active_module module").closest(".tb_holder").removeClass("tb_holder").addClass("tb_layout_part_parent").closest(".module_row").addClass("tb_active_layout_part_row");h.attr("id",b).removeClass("not_editable_builder").addClass("tb_active_builder").empty();e.el=f;c.id=e.id;var d=[];c.builderIndex=1;c.Instances.Builder[c.builderIndex]=new c.Views.Builder({el:h,collection:new c.Collections.Rows(a),type:c.mode});a=c.Instances.Builder[c.builderIndex].render().el.querySelectorAll("[data-cid]");
for(var b=0,m=a.length;b<m;++b)d[a[b].dataset.cid]=1;a=null;c.bootstrap(d,function(){f.triggerHandler("tb_layout_part_before_init");d=c.activeModel=null;c.Utils.loadContentJs(h);c.id=!1;t.body.on("themify_builder_change_mode",e.scrollTo);c.hasChanged=null;c.Instances.Builder[c.builderIndex].$el.triggerHandler("tb_init");f.find(".tb_toolbar_save").on("click",e.save.bind(e));f.find(".tb_toolbar_close_btn").on("click",e.close.bind(e));f.find(".tb_load_layout").on("click",c.Views.Toolbar.prototype.loadLayout);
f.find(".tb_toolbar_import ul a").on("click",c.Views.Toolbar.prototype["import"]);l.showLoader("hide");e.init=!1;e.undo=c.undoManager.stack;c.undoManager.btnUndo=f[0].getElementsByClassName("tb_undo_btn")[0];c.undoManager.btnRedo=f[0].getElementsByClassName("tb_redo_btn")[0];c.undoManager.reset();f.find(".tb_undo_redo").on("click",function(a){c.undoManager.do_change(a)});"desktop"!==c.activeBreakPoint&&c.Mixins.Builder.updateModuleSort(null,"disable");"visual"===c.mode&&setTimeout(function(){c.Utils.checkAllimageSize()},
500);c.ActionBar.disable=c.ActionBar.hoverCid=null;f.triggerHandler("tb_layout_part_after_init")})}c.ActionBar.disable=!0;l.showLoader("show");p.body.classList.add("tb_layout_part_edit");if(null!==c.activeModel){var d=l.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];d!==q&&d.click();d=null}r.document.body.classList.add("tb_layout_part_edit");var e=this,f=g(a).closest(".active_module"),h=f.find(".themify_builder_content"),k=l.templateCache.get("tmpl-small_toolbar");this.id=
h.data("postid");this.old_id=themifyBuilder.post_ID;this.init=!0;this.isSaved=null;this.cache[this.id]!==q?b(this.cache[this.id]):g.ajax({type:"POST",dataType:"json",url:themifyBuilder.ajaxurl,data:{action:"tb_layout_part_swap",nonce:themifyBuilder.tb_load_nonce,id:e.id},success:function(a){if(a.data){e.cache[e.id]=a.data;if(a.gs)for(var d=Object.keys(a.gs),f=d.length-1;-1<f;--f)c.GS.styles[d[f]]===q&&(c.GS.styles[d[f]]=a.gs[d[f]]),"visual"===c.mode&&!0!==c.GS.styles[d[f]].cssLoaded&&(c.liveStylingInstance.setCss(c.GS.styles[d[f]].data,
q,c.GS.styles[d[f]]["class"]),c.GS.styles[d[f]].cssLoaded=!0);b(a.data)}}})},close:function(a){function b(){d.el.removeClass("tb_active_layout_part").addClass("active_module module").closest(".tb_layout_part_parent").addClass("tb_holder").removeClass("tb_layout_part_parent").closest(".module_row").removeClass("tb_active_layout_part_row");g("#tb_small_toolbar",d.el).remove();for(var a=e[0].querySelectorAll("[data-cid]"),b=a.length-1;-1<b;--b){var f=a[b].dataset.cid,n=c.Models.Registry.lookup(f);n&&
(n.destroy(),c.Models.Registry.remove(f))}e.removeAttr("id").addClass("not_editable_builder").removeClass("tb_active_builder");p.body.classList.remove("tb_layout_part_edit");r.document.body.classList.remove("tb_layout_part_edit");g(".tb_overlay").remove();c.undoManager.stack=d.undo;c.undoManager.index=d.undo.length-1;c.undoManager.btnUndo=c.toolbar.el.getElementsByClassName("tb_undo_btn")[0];c.undoManager.btnRedo=c.toolbar.el.getElementsByClassName("tb_redo_btn")[0];themifyBuilder.post_ID=ThemifyStyles.builder_id=
d.old_id;d.undo=d.isSaved=d.old_id=d.html=d.id=d.options=d.isReload=d.el=c.Instances.Builder[c.builderIndex]=null;delete c.Instances.Builder[c.builderIndex];c.builderIndex=0;t.body.off("themify_builder_change_mode",d.scrollTo);c.Mixins.Builder.updateModuleSort();c.undoManager.updateUndoBtns();"desktop"!==c.activeBreakPoint&&c.Mixins.Builder.updateModuleSort(null,"disable");c.ActionBar.hoverCid=null;c.ActionBar.clear();c.Instances.Builder[c.builderIndex].lastRowAddBtn()}a.preventDefault();a.stopPropagation();
if(!c.hasChanged&&!c.undoManager.hasUndo()||null!==this.isSaved||confirm(themifyBuilder.i18n.layoutEditConfirm)){null!==c.activeModel&&l.Lightbox.close();var d=this,e=this.el.find(".themify_builder_content");if(null!==this.options){l.showLoader("show");a=c.Models.Registry.lookup(this.el.data("cid"));this.cache[this.id]=this.options;g(p).ajaxComplete(function k(a,f,u){if(-1!==u.data.indexOf("tb_load_module_partial",3))if(g(this).off("ajaxComplete",k),200===f.status){d.el=c.liveStylingInstance.$liveStyledElmt;
e=d.el.children(".themify_builder_content");var m=e[0].innerHTML,n="";d.el.children(".themify-builder-generated-css").each(function(){n+=this.outerHTML});g(".themify_builder_content-"+d.id).each(function(){var a=g(this).closest(".module");a.children("link.themify-builder-generated-css").remove();""!==n&&a[0].insertAdjacentHTML("afterbegin",n);this.innerHTML=m;c.Utils.loadContentJs(g(this))});n=m=null;l.showLoader("hide");b()}else l.showLoader("error")});var f=g.extend(!0,{},a.get("mod_settings"));
f.unsetKey=!0;a.trigger("custom:preview:refresh",f);f=null}else this.el[0].innerHTML=d.html,b(),g(".themify_builder_content-"+d.id).each(function(){g(this).closest(".active_module").find(".themify-builder-generated-css").removeAttr("disabled")}),c.Utils.loadContentJs(e)}},save:function(a,b){a.preventDefault();a.stopPropagation();if(null!==c.activeModel){var d=l.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];d!==q&&d.click();d=null}if(c.undoManager.hasUndo()||null!==this.isReload||
b){var e=this;this.old_settings=this.html=null;l.showLoader("show");c.Utils.saveBuilder(function(d){d.success&&(e.options=d.data.builder_data,c.hasChanged=null,e.isSaved=!0,b&&e.close(a))},1)}else l.showLoader("show"),setTimeout(function(){l.showLoader("hide")},100)}},reLoad:function(a,b,d){function e(){"visual"===c.mode&&(c.liveStylingInstance.setCss(c.Mixins.Builder.toJSON(c.Instances.Builder[h].el)),c.Utils.loadContentJs(c.Instances.Builder[h].$el),c.id=!1);c.Instances.Builder[c.builderIndex].$el.triggerHandler("tb_init");
l.showLoader("hide");"visual"===c.mode&&"desktop"!==c.activeBreakPoint&&(g("body",r.document).height(p.body.scrollHeight),setTimeout(function(){g("body",r.document).height(p.body.scrollHeight)},2E3));d&&d();c.hasChanged=!0;"visual"===c.mode&&setTimeout(function(){c.Utils.checkAllimageSize()},500)}var f=null!==c.Forms.LayoutPart.id,h=c.builderIndex,k=null,m="";c.Mixins.Builder.updateModuleSort(null,"destroy");f||(c.Models.Registry.destroy(),c.Instances.Builder={});"visual"===c.mode?(m="#themify_builder_content-"+
b,c.id=b,f||(c.liveStylingInstance.reset(),c.editing=!1,t.body.addClass("sidebar-none full_width"),g("#sidebar,.page-title").remove())):m="#tb_row_wrapper";if(f){b=c.Instances.Builder[h].el.querySelectorAll("[data-cid]");c.Forms.LayoutPart.isReload=!0;for(var n=0,u=b.length;n<u;++n){var q=b[n].dataset.cid,z=c.Models.Registry.lookup(q);z&&(z.destroy(),c.Models.Registry.remove(q))}b=null;c.Instances.Builder[h].$el.empty()}c.Instances.Builder[h]=new c.Views.Builder({el:m,collection:new c.Collections.Rows(a),
type:c.mode});c.Instances.Builder[h].render();c.undoManager.reset();if(f){k=[];b=c.Instances.Builder[h].el.querySelectorAll("[data-cid]");n=0;for(u=b.length;n<u;++n)k[b[n].dataset.cid]=1;b=null}"visual"===c.mode?c.bootstrap(k,e):e()},isValidate:function(a){var b=a.getElementsByClassName("tb_must_validate"),d=b.length;if(0===d)return!0;for(var e=!0,d=d-1;-1<d;--d){var f=b[d].getElementsByClassName("tb_lb_option")[0],h=b[d].getAttribute("data-validation"),g=f.value;if(c.Forms.get_validator(h)(g))for(f.classList.remove("tb_field_error"),
f=b[d].getElementsByClassName("tb_field_error_msg"),h=f.length-1;-1<h;--h)f[h].parentNode.removeChild(f[h]);else f.classList.contains("tb_field_error")||(e=p.createElement("span"),e.className="tb_field_error_msg",e.textContent=b[d].getAttribute("data-error-msg"),f.classList.add("tb_field_error"),f="SELECT"===f.tagName?f.parentNode:f,f.parentNode.insertBefore(e,f.nextSibling)),e=!1}!1===e&&(a=l.Lightbox.$lightbox.find('[href="#'+a.getAttribute("id")+'"]')[0],a.parentNode.classList.contains("current")||
a.click());return e}};c.Utils={onResizeEvents:[],gridClass:"col-full col2-1 col3-1 col4-1 col5-1 col6-1 col4-2 col4-3 col3-2".split(" "),_onResize:function(a,b){var d=g._data(v,"events").resize;g(r).off("tfsmartresize.tb_visual").on("tfsmartresize.tb_visual",function(a){""===tbLocalScript.fullwidth_support&&(g(v).triggerHandler("tfsmartresize.tbfullwidth"),g(v).triggerHandler("tfsmartresize.tfVideo"))}).off("tfsmartresize.zoom").on("tfsmartresize.zoom",function(){if(c.zoomMeta.isActive){var a="50"==
c.zoomMeta.size?2:1.25;g(".tb_workspace_container",r.document).css("height",Math.max(r.innerHeight*a,600))}});if(d!==q)for(var e=0,f=d.length;e<f;++e)d[e].handler!==q&&this.onResizeEvents.push(d[e].handler);g(v).off("resize");if(a){d=g.Event("resize",{type:"resize",isTrigger:!1});e=0;for(f=this.onResizeEvents.length;e<f;++e)try{this.onResizeEvents[e].apply(v,[d,g])}catch(h){}"function"===typeof b&&b()}},_addNewColumn:function(a,b){var d=c.Views.init_column({grid_class:a.newclass,component_name:a.component});
b.appendChild(d.view.render().el)},filterClass:function(a){a=a.split(" ");for(var b=[],d=a.length-1;-1<d;--d)-1!==this.gridClass.indexOf(a[d])&&b.push(a[d]);return b.join(" ")},_getRowSettings:function(a,b){var d={};b=b||"row";var e={};var f,g=c.Models.Registry.lookup(a.getAttribute("data-cid"));if(g){var k=a.getElementsByClassName(b+"_inner")[0];e=k.children;for(var m=this,n=function(a){a=a.children;for(var b=0,d=a.length;b<d;++b){a[b].classList.contains("active_module")||n(a[b]);var e=c.Models.Registry.lookup(a[b].getAttribute("data-cid"));
e&&(f=e.get("mod_settings"),e=t.push({mod_name:e.get("mod_name"),element_id:e.get("element_id")})-1,f&&0<Object.keys(f).length&&(delete f.cid,t[e].mod_settings=f),a[b].classList.contains("module_subrow")&&(t[e]=m._getRowSettings(a[b],"subrow")))}},l=0,p=e.length;l<p;++l){var r={};var x=c.Models.Registry.lookup(e[l].getAttribute("data-cid"));if(x){r=e[l].getElementsByClassName("tb_holder")[0];var t=[];r!==q&&n(r);d[l]={element_id:x.get("element_id"),grid_class:this.filterClass(e[l].className)};t&&
0<t.length&&(d[l].modules=t);r=parseFloat(e[l].style.width);0<r&&!isNaN(r)&&(d[l].grid_width=r);(f=x.get("styling"))&&0<Object.keys(f).length&&(delete f.cid,d[l].styling=f)}}e={element_id:g.get("element_id"),cols:d,column_alignment:g.get("column_alignment"),gutter:g.get("gutter"),column_h:g.get("column_h")};p={gutter:"gutter-default",column_alignment:D?"col_align_middle":"col_align_top"};d={desktop_dir:"ltr",tablet_dir:"ltr",tablet_landscape_dir:"ltr",mobile_dir:"ltr",col_tablet_landscape:"-auto",
col_tablet:"-auto",col_mobile:"-auto"};for(l in e)""!==e[l]&&null!==e[l]&&e[l]!==p[l]||delete e[l];f=g.get("styling");for(l in d)g=k.getAttribute("data-"+l),null===g||""===g||g===d[l]||"-auto"===d[l]&&-1!==g.indexOf("-auto")||(e[l]=g.trim());f&&0<Object.keys(f).length&&(delete f.cid,e.styling=f)}return e},selectedGridMenu:function(a,b){var d=ThemifyConstructor.breakpointsReverse,e=c.Models.Registry.lookup(a.getAttribute("data-cid")),f=a.getElementsByClassName(b+"_inner")[0],g=e.get("gutter"),k=e.get("column_alignment"),
m=e.get("column_h");var n=e.get("desktop_dir");var l="row"===b?e.get("styling"):null,p=[],r={};var t=f.children;for(var v=0,B=t.length;v<B;++v)t[v].className=t[v].className.replace(/first|last/ig,""),1!==B&&(0===v?t[v].className+="rtl"===n?" last":" first":v===B-1&&(t[v].className+="rtl"===n?" first":" last"));t=t.length;p.push("col-count-"+t);r["data-basecol"]=t;null!==l&&l.row_anchor!==q&&""!==l.row_anchor&&(a.getElementsByClassName("tb_row_anchor")[0].textContent=l.row_anchor);"gutter-default"!==
g&&p.push(g);m&&p.push("col_auto_height");k||(k="col_align_top");p.push(k);"ltr"!==n&&p.push("direction-rtl");for(g=d.length-1;-1<g;--g)n=e.get(d[g]+"_dir"),"ltr"!==n&&""!==n&&(r["data-"+d[g]+"_dir"]=n),"desktop"!==d[g]&&(t=e.get("col_"+d[g]),"-auto"!==t&&""!==t&&t!==q&&(r["data-col_"+d[g]]=t));for(v=p.length-1;-1<v;--v)p[v]&&f.classList.add(p[v]);for(v in r)f.setAttribute(v,r[v])},clear:function(a,b,d){b===q&&(b=Array.isArray(a));var c=!0===b?[]:{},f;for(f in a)if(Array.isArray(a[f])){var h=this.clear(a[f],
!0,1);0<h.length&&(!0===b?c.push(h):c[f]=h)}else if("object"===typeof a[f])h=this.clear(a[f],!1,1),g.isEmptyObject(h)||(c[f]=h);else if(null!==a[f]&&a[f]!==q&&""!==a[f]&&"def"!==a[f]&&""!==f&&"pixels"!==a[f]&&"default"!==a[f]&&"|"!==a[f]&&!("show"===a[f]&&0===f.indexOf("visibility_")||"unstick_when_condition"===f&&"hits"===a[f]||("stick_at_pos_val_unit"===f||"unstick_when_pos_val_unit"===f)&&"px"===a[f]))if("custom_parallax_scroll_speed"!==f||a[f]&&"0"!=a[f])if("unstick_when_element"===f&&"builder_end"===
a[f]||"stick_at_check"===f&&"stick_at_check"!==a[f])delete c.unstick_when_el_row_id,delete c.unstick_when_el_mod_id,delete c.unstick_when_condition,delete a.unstick_when_el_row_id,delete a.unstick_when_el_mod_id,delete a.unstick_when_condition,delete c.unstick_when_pos,delete c.unstick_when_pos_val,delete c.unstick_when_element,delete c.unstick_when_pos_val_unit,delete a.unstick_when_pos,delete a.unstick_when_pos_val,delete a.unstick_when_pos_val_unit,delete a.unstick_when_element,"stick_at_check"===
f&&(delete a[f],delete c[f],delete a.stick_at_position,delete c.stick_at_position);else if("stick_at_position"===f&&"top"===a[f]||"__dc__"===f&&"{}"===a[f]||"background_gradient-css"===f||"cover_gradient-css"===f||"cover_gradient_hover-css"===f||"background_image-type_image"===f||"custom_parallax_scroll_reverse_reverse"===f||"|single"===a[f]||"|multiple"===a[f]||("custom_parallax_scroll_reverse"===f||"custom_parallax_scroll_fade"===f||"visibility_all"===f||"sticky_visibility"===f)&&!a[f])delete a[f],
delete c[f];else{if(1===d){var k=[];if("image"!==a[f]||"background_type"!==f&&"b_t_h"!==f&&"background_image-type"!==f&&"b_i_h-type"!==f)if("px"===a[f]&&-1!==f.indexOf("_unit",2))h=f.replace("_unit",""),a[h]||k.push(f);else if(0===f.indexOf("checkbox_")&&-1!==f.indexOf("_apply_all",6)){a[f]?c[f]=a[f]:k.push(f);h=f.replace("_apply_all","").replace("checkbox_","");for(var m=["top","left","right","bottom"],n=3;-1<n;--n){var l=h+"_"+m[n]+"_unit";"px"===a[l]?k.push(l):a[l]!==q&&null!==a[l]&&""!==a[l]&&
(c[l]=a[l])}}else-1!==f.indexOf("gradient",3)?("180"==a[f]||"linear"===a[f]||a[f]===g.ThemifyGradient["default"]||!1===a[f]&&-1!==f.indexOf("-circle-radial",3))&&k.push(f):("background_zoom"===f&&""===a[f]||"solid"===a[f]||!1===a[f]&&(-1!==f.indexOf("_user_role",3)||-1!==f.indexOf("_appearance",3)))&&k.push(f);else k.push(f);if(0<k.length){for(n=k.length-1;-1<n;--n)delete c[k[n]],delete a[k[n]];k.length=0;continue}}!0===b?c.push(a[f]):c[f]=a[f]}else delete c.custom_parallax_scroll_reverse,delete c.custom_parallax_scroll_fade,
delete c[f],delete a.custom_parallax_scroll_reverse,delete a.custom_parallax_scroll_fade,delete a[f];return c},clearElementId:function(a,b){for(var d in a){!0===b?a[d].element_id=c.Utils.generateUniqueID():delete a[d].element_id;var e=a[d].styling!==q?a[d].styling:a[d].mod_settings;if(e!==q){if(e.custom_css_id!==q&&""!==e.custom_css_id)for(var f=2;;){var g=e.custom_css_id+"-"+f.toString(),k=p.getElementById(g);if(null===k||null===k.closest(".module_row")){e.custom_css_id=g;break}++f}e.builder_content!==
q&&(f=JSON.parse(e.builder_content),this.clearElementId(f,!0),e.builder_content=JSON.stringify(f))}a[d].cols!==q?this.clearElementId(a[d].cols,b):a[d].modules!==q&&this.clearElementId(a[d].modules,b)}},clearLastEmptyRow:function(a){for(var b=a.length-1;-1<b;--b){var d=a[b].attributes!==q?a[b].attributes:a[b];if(d.styling===q||null===d.styling||0===Object.keys(d.styling).length){var d=d.cols,e=!0,f;for(f in d)if(d[f].modules!==q&&(0<d[f].modules.length||0<Object.keys(d[f].modules).length)||d[f].styling!==
q&&null!==d[f].styling&&0<Object.keys(d[f].styling).length){e=!1;break}if(!0===e)a[b].cid!==q&&(c.Models.Registry.remove(a[b].cid),a[b].destroy()),a.splice(b,1);else break}else break}},builderPlupload:function(a,b){var d=b?!0:!1,e=d?[b]:l.Lightbox.$lightbox[0].getElementsByClassName("tb_plupload_upload_uic"),f=e.length;if(0<f){var h=d?!1:"new_elemn"===a?".plupload-clone":!1;this.pconfig===q&&(this.pconfig=JSON.parse(JSON.stringify(themify_builder_plupload_init)),this.pconfig.multipart_params._ajax_nonce=
themifyBuilder.tb_load_nonce,this.pconfig.multipart_params.topost=themifyBuilder.post_ID);for(--f;-1<f;--f)if(!e[f].classList.contains("tb_plupload_init")&&(!1===h||e[f].classList.contains(h))){var k=e[f],m=k.getAttribute("id").replace("tb_plupload_upload_ui",""),n=g.extend(!0,{},this.pconfig),p=k.getAttribute("data-extensions"),w=["browse_button","container","drop_element","file_data_name"];n.multipart_params.imgid=m;for(var z=w.length-1;-1<z;--z)n[w[z]]=m+this.pconfig[w[z]];n.filters[0].extensions=
null!==p?p:null!==c.activeModel?n.filters[0].extensions.replace(/\,zip|\,txt/,""):"zip,txt";m=new r.plupload.Uploader(n);k.classList.add("tb_plupload_init");d&&m.bind("init",function(a){g(a.settings.browse_button).click()});m.bind("FilesAdded",function(a,b){a.refresh();a.start();l.showLoader("show")});m.bind("Error",function(a,b){var d=g(".prompt-box .show-error");g(".prompt-box .show-login").hide();d.show();0<d.length&&d.html('<p class="prompt-error">'+b.message+"</p>");g(".overlay, .prompt-box").fadeIn(500)});
m.bind("FileUploaded",function(a,b,f){var e=JSON.parse(f.response);a=g("#tb_alert",r.document);f=200!==f.status||e.error?"error":"done";if(e.error)l.showLoader(f),alert(e.error);else if(d){var h=g("#tb_row_wrapper").children().clone(!0);a.promise().done(function(){c.Forms.reLoad(e.builder_data,themifyBuilder.post_ID);var a=g("#tb_row_wrapper").children().clone(!0);l.Lightbox.close();"visual"===c.mode&&q!==e.gsType&&(themifyBuilder.globalStyleData.type=e.gsType);if(e.used_gs)for(var b=Object.keys(e.used_gs),
d=b.length-1;-1<d;--d)c.GS.styles[b[d]]==q&&(c.GS.styles[b[d]]=e.used_gs[b[d]]),"visual"===c.mode&&!0!==c.GS.styles[b[d]].cssLoaded&&(c.liveStylingInstance.setCss(c.GS.styles[b[d]].data,q,c.GS.styles[b[d]]["class"]),c.GS.styles[b[d]].cssLoaded=!0);c.undoManager.push("","","","import",{before:h,after:a,bid:themifyBuilder.post_ID})})}else l.showLoader(f),a=this.getOption().container.closest(".tb_input"),f=a.getElementsByClassName("tb_uploader_input")[0],a=a.getElementsByClassName("thumb_preview")[0],
f.value=e.large_url?e.large_url:e.url,a!==q&&ThemifyConstructor.file.setImage(a,e.thumb),t.triggerEvent(f,"change")});m.init();k.classList.remove("plupload-clone")}}},columnDrag:function(a,b,d,e){var f=this;b&&(b=a?a.children(".module_column"):g(".module_column"),b.css("width",""),f.setCompactMode(b));if(d&&e){a=a.children(".module_column");var h=("gutter-narrow"===d?1.6:"gutter-none"===d?0:3.2)-("gutter-narrow"===e?1.6:"gutter-none"===e?0:3.2),h=parseFloat(h*(a.length-1)/a.length);a.each(function(a){g(this).prop("style").width&&
(a=parseFloat(g(this).prop("style").width)+h,g(this).css("width",a+"%"))})}else{var k={"col6-1":14,"col5-1":17.44,"col4-1":22.6,"col4-2":48.4,"col2-1":48.4,"col4-3":74.2,"col3-1":31.2,"col3-2":65.6},m={"col6-1":15.33,"col5-1":18.72,"col4-1":23.8,"col4-2":49.2,"col2-1":49.2,"col4-3":74.539,"col3-1":32.266,"col3-2":66.05},n={"col6-1":16.666,"col5-1":20,"col4-1":25,"col4-2":50,"col2-1":50,"col4-3":75,"col3-1":33.333,"col3-2":66.666};(a?a.children(".module_column").find(".tb_grid_drag"):g(".tb_grid_drag")).each(function(){var a,
b,d,e,h=0,p,q=!1,r=0,v=!1,y,A,C,F=null,D=null,G;g(this).draggable({axis:"x",cursor:"col-resize",distance:0,scroll:!1,snap:!1,containment:".row_inner",helper:function(d){a=g(d.currentTarget);b=a.closest(".subrow_inner");0===b.length&&(b=a.closest(".row_inner"));p=a[0].classList.contains("tb_drag_right")?"w":"e";y="w"===p?"tb_grid_drag_right_tooltip":"tb_grid_drag_left_tooltip";v=l.clone(b.closest(".module_row"));b.addClass("tb_drag_column_start");return g('<div class="ui-widget-header tb_grid_drag_tooltip '+
y+'"></div><div class="ui-widget-header tb_grid_drag_tooltip"></div>')},start:function(f,g){c.ActionBar.disable=!0;c.ActionBar.clear();d=b.children(".module_column");e=a.closest(".module_column");C=b[0].classList.contains("direction-rtl");"w"===p?(q=C?e.prev(".module_column"):e.next(".module_column"),h=a.outerWidth(),G=e.outerWidth()):(q=C?e.next(".module_column"):e.prev(".module_column"),G=h=e.outerWidth());h=parseInt(h);r=parseInt(q.outerWidth())-2;A=b.outerWidth();F=e.addClass("tb_drag_column_current").children("."+
y)[0];D=e.children(".tb_grid_drag_tooltip").last()[0]},stop:function(a,l){g(".tb_grid_drag_tooltip").remove();b.removeClass("tb_drag_column_start");var u=Math.ceil(100*(e.outerWidth()/A));e.removeClass("tb_drag_column_current").css("width",u+"%");var w=k,u=3.2;b[0].classList.contains("gutter-narrow")?(w=m,u=1.6):b[0].classList.contains("gutter-none")&&(w=n,u=0);var z=u*(d.length-1);d.each(function(a){a!==q.index()&&(g(this).prop("style").width?a=parseFloat(g(this).prop("style").width):(a=g.trim(f.filterClass(g(this).attr("class")).replace("first",
"").replace("last","")),a=w[a]),z+=a)});q.css("width",100-z+"%");q=q.add(e);f.setCompactMode(q);var u=b.closest(".module_row"),x=!0===c.hasChanged;c.hasChanged=!0;c.undoManager.push(u.data("cid"),v,u,"row");c.hasChanged=x;t.body.triggerHandler("tb_grid_changed",[u]);setTimeout(function(){c.ActionBar.disable=null},5);F=D=h=r=A=G=q=y=e=p=C=b=d=null},drag:function(a,b){if(q&&0<q.length){var d=parseInt(b.position.left),d=h+("e"===p?-d:d),c=parseFloat(100*d/A);if(5<=c&&100>c){var f=r,f=f+("w"===p?-(d-
G):G-d),g=parseFloat(100*f/A);5<g&&100>g&&(q.css("width",f+"px"),e.css("width",d+"px"),F.innerHTML=c.toFixed(2)+"%",D.innerHTML=g.toFixed(2)+"%")}}}})})}},grid:function(a){var b=[];a=parseInt(a);if(1===a)b.push({grid_class:"col-full"});else for(var d=0;d<a;++d)b.push({grid_class:"col"+a+"-1"});return[{cols:b}]},setCompactMode:function(a){a instanceof jQuery&&(a=a.get());for(var b=a.length-1;-1<b;--b)185>a[b].clientWidth?a[b].classList.add("compact-mode"):a[b].classList.remove("compact-mode")},initNewEditor:function(a){if(3<
parseInt(tinyMCE.majorVersion)){var b=tinyMCEPreInit.mceInit.tb_lb_hidden_editor;b.elements=a;b.selector="#"+a;a=new tinyMCE.Editor(a,b,tinyMCE.EditorManager);a.render();return a}},initQuickTags:function(a){"function"===typeof r.QTags&&(r.quicktags({id:a}),r.QTags._buttonsInit())},_getColClass:function(a){for(var b=0,d=a.length;b<d;++b)if(-1!==this.gridClass.indexOf(a[b]))return a[b].replace("col","")},saveBuilder:function(a,b,d){b=b||0;if(0===b){if(null!==c.activeModel||0<l.Lightbox.$lightbox.length&&
l.Lightbox.$lightbox[0].classList.contains("tb_custom_css_lightbox")){var e=l.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];e!==q&&e.click();e=null}l.showLoader("show")}var f=Object.keys(c.Instances.Builder).length,h=c.Instances.Builder[b],k=this,e=h.$el.data("postid"),h=c.Mixins.Builder.toJSON(h.el);(function(a,b){var e=ThemifyStyles.createCss(b,null,!0);b=c.Utils.clear(b);if(Object.keys(c.GS.styles).length){var f=c.GS.findUsedItems(b);!1!==f&&(e=c.GS.attachCSS(e,f))}f={action:"tb_save_data",
tb_load_nonce:themifyBuilder.tb_load_nonce,id:a,data:JSON.stringify(b),custom_css:A,sourceEditor:"visual"===c.mode?"frontend":"backend"};d&&(f.only_data=d);g.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:{css:JSON.stringify(e),action:"tb_save_css",custom_css:A,tb_load_nonce:f.tb_load_nonce,id:f.id}});return g.ajax({type:"POST",url:themifyBuilder.ajaxurl,cache:!1,data:f})})(e,h).always(function(e,h){++b;f===b?(g.isFunction(a)&&a.call(k,e,h),"success"!==h?l.showLoader("error"):(l.showLoader("hide"),
c.editing=!0,t.body.triggerHandler("themify_builder_save_data",[e,h]))):setTimeout(function(){k.saveBuilder(a,b,d)},50)})},loadContentJs:function(a,b){ThemifyBuilderModuleJs.loadOnAjax(a,b);if(!1===c.saving){var d=g("audio.wp-audio-shortcode, video.wp-video-shortcode",a);if(0<d.length){if(themifyBuilder.media_css){for(var e in themifyBuilder.media_css)t.LoadCss(themifyBuilder.media_css[e]);themifyBuilder.media_css=null}d.each(function(){var a=g(this).closest(".mejs-mediaelement");0<a.length&&(this.removeAttribute("style"),
this.setAttribute("id",this.getAttribute("id").replace("_html5","")),a.closest(".widget").html(this))});d.mediaelementplayer("undefined"!==typeof r._wpmejsSettings?r._wpmejsSettings:{})}}t.body.triggerHandler("builder_load_module_partial",[a,b])},createClearBtn:function(a){a.siblings(".tb_clear_btn").click(function(){g(this).hide();a.val("").trigger("keyup")})},toRGBA:function(a){return ThemifyStyles.toRGBA(a)},getColor:function(a){var b=a.value;""!==b&&(null!==a.getAttribute("data-minicolors-initialized")?
...
q){var a=p.createElement("fakeelement"),b={transition:"transitionend",OTransition:"oTransitionEnd",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"},d;for(d in b)if(a.style[d]!==q){this.transitionPrefix.pre=b[d];break}}return this.transitionPrefix.pre},generateUniqueID:function(){return(Math.random().toString(36).substr(2,4)+(new Date).getUTCMilliseconds().toString()).substr(0,7)},getUIDList:function(a){a=a||"row";var b=_.pluck(c.Models.Registry.items,"attributes");return _.where(b,
...
200-e.offsetParent().offset().top):e=a.offsetTop;g(d).scrollTop(e)}}},addViewPortClass:function(a){this.removeViewPortClass(a);var b=this.isInViewport(a);if(!1!==b)for(var b=b.split(" "),d=b.length-1;-1<d;--d)""!==b[d]&&a.classList.add(b[d])},removeViewPortClass:function(a){for(var b=["top","left","bottom","right"],d=4;-1<d;--d)a.classList.remove("tb_touch_"+b[d])},isInViewport:function(a){a=a.getBoundingClientRect();var b="";0>a.left?b="tb_touch_left":a.right-1>=p.documentElement.clientWidth&&(b=
"tb_touch_right");0>a.top?b+=" tb_touch_top":a.bottom+1>=p.documentElement.clientHeight&&(b+=" tb_touch_bottom");return""===b?!1:b},checkImageSize:function(a){var b=a.getElementsByTagName("img")[0],d=function(d){b.width<d?a.classList.add("tb_disable_object_fit"):a.classList.remove("tb_disable_object_fit")};if(b!==q){var c=b.naturalWidth;if(c&&b.complete)d(c);else{var f=new Image;f.onload=function(){d(f.width)};f.src=b.src}}else a.classList.remove("tb_disable_object_fit")},checkAllimageSize:function(){var a=
c.Instances.Builder[c.builderIndex].el,b=c.Models.Registry.items,d;for(d in b)if("image"===b[d].attributes.mod_name){var e=a.getElementsByClassName("tb_element_cid_"+b[d].cid)[0];e!==q&&this.checkImageSize(e)}},hideOnClick:function(a){a[0]!==q&&(a=a[0]);if(a.classList.contains("tb_ui_dropdown_items")||a.classList.contains("tb_down"))a.classList.add("tb_hide_option"),a.previousElementSibling.blur(),setTimeout(function(){a.classList.remove("tb_hide_option")},500)},changeOptions:function(a,b){var d=
"INPUT"===a.tagName?"keyup":"change",e=this;"keyup"===d&&a.setAttribute("data-prev",a.value);e.custom_css_id=function(a,b,d,c){a=p.getElementById(c);return null===a||d[0].getAttribute("id")===c||null===a.closest(".module_row")?(d[0].setAttribute("id",c),!0):!1};e.row_anchor=function(a,b,d,e){"visual"===c.mode&&(d.removeClass(c.liveStylingInstance.getRowAnchorClass(a.getAttribute("data-prev"))),""!==e&&d.addClass(c.liveStylingInstance.getRowAnchorClass(e)),d.data("anchor",e).attr("data-anchor",e));
c.hasChanged=!0;d.find(".tb_row_anchor").first().text(e.replace("#",""));return!0};e.custom_css=function(a,b,d,e){"visual"===c.mode&&d.removeClass(a.getAttribute("data-prev")).addClass(e);return!0};e.layout=function(a,b,d,e){"visual"===c.mode&&c.liveStylingInstance.bindRowWidthHeight(b,e,d);return!0};a.addEventListener(d,function(a){var f=null!==c.activeModel&&c.ActionBar.cid===c.activeModel.cid,k=!l.Lightbox.$lightbox[0].contains(this),m=this.id,n="custom_css_id"===m,r=!0!==n||!1!==k&&!0!==f?q:l.Lightbox.$lightbox[0].getElementsByClassName("builder_save_button")[0];
var t=!0===k&&!1===f?g(".tb_element_cid_"+c.ActionBar.cid):"visual"===c.mode?c.liveStylingInstance.$liveStyledElmt:g(".tb_element_cid_"+c.activeModel.cid);var v=this.value;"keyup"===d&&"custom_css"!==b?((v=v.trim())&&(v=v.replace(/[^a-zA-Z0-9\-\_]+/gi,"")),this.value=v):"layout"===b&&(v=a.detail.val);if(e[b].call(e,this,m,t,v)){n&&(g(this).next(".tb_field_error_msg").remove(),r!==q&&r.classList.remove("tb_disable_save"));if(!0===k){var x=function(){var a=v;"keyup"===d&&(this.removeEventListener("change",
x,{passive:!0,once:!0}),this.removeAttribute("data-isInit"),a=this.value.trim());var b=c.Models.Registry.lookup(t.data("cid")),e=b.get("styling");e||(e={});e[m]=a;b.set({styling:e},{silent:!0})};"keyup"===d?this.getAttribute("data-isInit")||(this.setAttribute("data-isInit",1),this.addEventListener("change",x,{passive:!0,once:!0})):x()}c.hasChanged=!0}else n&&(a=p.createElement("span"),a.className="tb_field_error_msg",a.textContent=ThemifyConstructor.label.errorId,this.parentNode.insertBefore(a,this.nextSibling),
r!==q&&r.classList.add("tb_disable_save"));!0===f&&(f=k?l.Lightbox.$lightbox.find("#"+m):g("#"+c.ActionBar.el.id).find("#"+m),"keyup"===d?f.val(v).attr("data-prev",v):"layout"===b&&(f.find(".selected").removeClass("selected"),""!==v?f.find("#"+v).addClass("selected"):f.children().first().addClass("selected")));"keyup"===d&&this.setAttribute("data-prev",v)},{passive:!0})}};c.ActionBar={cid:null,topH:null,type:null,disable:null,prevExpand:null,needClear:!0,el:null,breadCrumbs:null,disablePosition:null,
isInit:null,isHoverMode:!0,hoverCid:null,init:function(){if(null===this.isInit){this.isInit=!0;this.el=p.createElement("div");this.breadCrumbs=p.createElement("ul");this.el.id="tb_component_bar";this.breadCrumbs.className="tb_action_breadcrumb";this.el.addEventListener("mousedown",this.mouseDown.bind(this));this.topH=c.toolbar.$el.height();"visual"===c.mode?p.body.appendChild(this.el):c.Instances.Builder[c.builderIndex].el.parentNode.appendChild(this.el);p.addEventListener("click",this.click.bind(this));
p.addEventListener("dblclick",this.click.bind(this));c.Instances.Builder[0].el.addEventListener("mouseover",this.enter);"visual"===c.mode&&r.document.addEventListener("click",this.click.bind(this));var a="visual"===c.mode?null:p.getElementById("tb_canvas_block");null===a?(p.addEventListener("keydown",this.actions.bind(this)),r.document.addEventListener("keydown",this.actions.bind(this))):a.addEventListener("keydown",this.actions.bind(this));this.changeMode()}},changeMode:function(){this.hoverCid=
null;var a=this,b=function(b){a.actions(b)};!0===this.isHoverMode?(p.body.classList.remove("tb_click_mode"),p.body.classList.add("tb_hover_mode"),this.el.removeEventListener("click",b)):(p.body.classList.remove("tb_hover_mode"),p.body.classList.add("tb_click_mode"),this.el.addEventListener("click",b))},enter:function(a){var b=c.ActionBar;c.Mixins.Builder.columnHover(a.target);if(!0===b.isHoverMode&&null===b.disablePosition&&null===b.disable){a.preventDefault();a.stopPropagation();var d=a.target,e=
null,f=d.classList;if(null!==b.prevExpand&&b.prevExpand!==q)if(b.prevExpand.contains(d)){if(f.contains("tb_inner_action_more")){var h=d.getElementsByTagName("UL");h.length&&c.Utils.addViewPortClass(h[0])}h=b.prevExpand.getElementsByClassName("tb_row_settings")[0];if(h!==q){var k=p.getElementById(h.getAttribute("data-href"));if(k.contains(d))return;k.classList.remove("selected");h.classList.remove("selected")}if("module"===b.type||"column"===b.type){"column"===b.type&&(b.hoverCid=d.parentNode.getAttribute("data-cid"));
return}}else{h="module"!==b.type;if(!1===h)"visual"!==c.mode?(h=d.closest(".active_module"),h=null!==h?h.getAttribute("data-cid")!==b.hoverCid:!0):(k=d.closest(".tb_dragger_top"),null!==k&&k.classList.contains("tb_dragger_padding")&&c.EdgeDrag.setModulePosition(k));else if(f.contains("tb_clicked"))return;!0===h&&b.clear()}if(null===d.closest(".tb_dragger_lightbox")){if(f.contains("tb_action_wrap"))e=!f.contains("tb_clicked");else{if("LI"===d.nodeName&&f.contains("tb_row_settings")&&!f.contains("selected")){b.actions(a);
return}if(!f.contains("tb_grid_drag")){d=g(d).closest("[data-cid]")[0];if(d===q)return;f=d.getAttribute("data-cid");if(b.hoverCid===f)return;b.hoverCid=f;h=c.Models.Registry.lookup(f);f=h.get("elType");if("module"===f){if(d.classList.contains("tb_element_selected"))return;e=!0}else if("visual"===c.mode){b.clear();c.EdgeDrag.addEdges(f,h,d);return}}}!0===e&&b.click(a)}}},mouseDown:function(a){if(1===a.which&&("row"===this.type||"subrow"===this.type)&&a.target.classList.contains("ti-move")){a.preventDefault();
a.stopPropagation();var b=c.Instances.Builder[c.builderIndex].$el.find(".tb_element_cid_"+this.cid);if(0<b.length){a="row"===this.type?b[0].getElementsByClassName("tb_row_action")[0]:b[0];var b=b.offset();this.clear();if("function"===typeof Event)var d=new Event("mousedown",{bubbles:!0,cancelable:!1});else d=p.createEvent("Event"),d.initEvent("mousedown",!0,!1);d.pageX=b.left;d.pageY=b.top;d.which=1;a.dispatchEvent(d)}}},click:function(a){if(c.isPreview||!0===this.disable)return!0;var b=a.target,
d=b.tagName;var e=c.Instances.Builder[c.builderIndex].lastRow;var f="visual"===c.mode&&b.ownerDocument===r.document?q:g(b).closest("[data-cid]")[0],h=a.type;if("click"===h){if(r.document.body.classList.contains("tb_standalone_lightbox")&&!r.document.body.classList.contains("modal-open")){c.toolbar.el.contains(b)||l.Lightbox.$lightbox[0].contains(b)||l.Lightbox.$lightbox[0].classList.contains("tb_predesigned_lightbox")||l.Lightbox.close();var k=r.document.getElementsByClassName("tb_current_menu_selected")[0];
k!==q&&k.classList.remove("tb_current_menu_selected");k=null}e&&!e.contains(b)&&e.classList.remove("expanded");if(!0===this.isHoverMode&&!l.Lightbox.$lightbox[0].contains(b)){e=c.Instances.Builder[0].el.getElementsByClassName("tb_element_clicked");for(k=e.length-1;-1<k;--k)e[k].classList.remove("tb_element_clicked");e=null;f!==q&&f.classList.add("tb_element_clicked")}}else if("dblclick"===h&&null!==c.Forms.LayoutPart.id&&b.classList.contains("tb_overlay")){c.Forms.LayoutPart.save(a,!0);return}k=("click"===
h||"dblclick"===h)&&"visual"===c.mode&&l.Lightbox.dockMode.get();if(f===q||!("dblclick"===h||!0===k&&b.classList.contains("tb_dragger"))&&b.classList.contains("tb_disable_sorting")||f.classList.contains("tb_active_layout_part"))"LI"===d&&b.classList.contains("tb_bread")?(e=c.Models.Registry.lookup(b.getAttribute("data-id")),"setting"!==ThemifyConstructor.clicked&&"module"===ThemifyConstructor.component&&(a=l.Lightbox.$lightbox[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector(".current a").getAttribute("href"),
l.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs").on("themify_opened_lightbox.tb_breadCrumbs",function(){"row"===ThemifyConstructor.component?l.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")[0].getElementsByClassName("tb_lightbox_top_bar")[0].querySelector('a[href="'+this+'"]').click():null===c.activeModel&&l.Lightbox.$lightbox.off("themify_opened_lightbox.tb_breadCrumbs")}.bind(a)),a=null),e.trigger("edit",null)):this.el.contains(b)||"click"===a.type&&b.classList.contains("tb_dragger")||
this.clear();else{"visual"!==c.mode||"A"!==d&&null===b.closest("a")||a.preventDefault();var m=f.getAttribute("data-cid");e=c.Models.Registry.lookup(m);var n=e.get("elType"),u="row"===n&&f.classList.contains("tb-page-break");if(e){if("dblclick"===h){if((!0===k||"INPUT"===d||!0===u||b.classList.contains("tb_dragger_lightbox")||null!==b.closest(".tb_clicked"))&&"tb_row_options"!==b.id)return;a.preventDefault();a.stopPropagation();f.classList.remove("tb_element_selected");!1===k&&!0!==this.isHoverMode&&
(f.classList.add("tb_element_selected"),t.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===n?e.get("mod_name"):n,e,f));if(!b.classList.contains("tb_row_settings")){e.trigger("edit",a,b);return}}else if("click"===h&&!1===k&&(b.classList.contains("tb_dragger")||null!==b.closest(".tb_dragger_options")))return;var w=!0===this.isHoverMode;var v=!0!==w&&null!==this.cid,d="module"!==n?b.classList.contains("tb_action_wrap"):!0===w;this.cid=m;this.type=n;if(!0===
u&&"row"===n)this.clear(),b.classList.contains("tb_row_anchor")&&(a.preventDefault(),a.stopPropagation(),e.trigger("delete",a,b));else if((!1===d||"module"===n&&!0===w)&&null!==b.closest(".tb_action_wrap"))"click"===h&&this.actions(a);else if(!0===w&&"click"===h&&!0===this.needClear)!0===k&&e.trigger("edit",a,b);else if(this.clear(),!0===v&&"click"===h&&!1===k&&!0===this.needClear){t.body[0].classList.add("tb_action_active");var x=this,y=function(){p.removeEventListener("mousemove",y,{passive:!0,
once:!0});null===x.cid&&t.body[0].classList.remove("tb_action_active")};p.removeEventListener("mousemove",y,{passive:!0,once:!0});p.addEventListener("mousemove",y,{passive:!0,once:!0})}else{this.cid=m;this.type=n;h="tmpl-builder_"+n+"_action";m=l.is_template_support?p.getElementById(h).content.cloneNode(!0):l.templateCache.get(h);if(!0===d){this.prevExpand="module"===n?f.getElementsByClassName("tb_module_action")[0]:b;if(this.prevExpand===q){this.clear();return}l.is_template_support?this.prevExpand.appendChild(m):
this.prevExpand.insertAdjacentHTML("beforeend",m);this.prevExpand.setAttribute("id",this.el.id);this.prevExpand.style.top="";this.prevExpand.closest(".tb_action_wrap").classList.add("tb_clicked");!0===w&&"module"===n&&"visual"===c.mode&&(c.EdgeDrag.addEdges(e.get("mod_name"),e,f),null===f.nextElementSibling&&(h=f.parentNode.nextElementSibling,null!==h&&(h=this.prevExpand.getBoundingClientRect().bottom-h.getBoundingClientRect().top,0<=h&&(this.prevExpand.style.top=this.prevExpand.offsetTop-h+"px"))))}else"row"!==
n&&this.setBreadCrumbs(f),this.el.className="tb_show_toolbar tb_"+n+"_action",h=p.createElement("div"),h.className="tb_action_label_wrap",l.is_template_support?h.appendChild(m):h.insertAdjacentHTML("beforeend",m),"visual"===c.mode&&("module"===n?(m=e.get("mod_name"),this.el.className+=" tb_"+m+"_action",m=themifyBuilder.modules[m].name):(m=n,"row"===n&&(u=e.get("styling").row_anchor,u!==q&&(u=u.trim(),""!==u&&(m+=" #"+u)))),u=p.createElement("div"),u.className="tb_data_mod_name",u.textContent=m.charAt(0).toUpperCase()+
m.slice(1),h.appendChild(u)),this.el.appendChild(h);f.classList.add("tb_element_selected");!0!==w&&(t.body[0].classList.add("tb_action_active"),"visual"===c.mode&&c.EdgeDrag.addEdges("module"===n?e.get("mod_name"):n,e,f));if(!0===k&&(e.trigger("edit",a,b),!0===w||null!==this.disablePosition&&!1!==d&&!0===w))return;null===this.disablePosition&&(!1===d&&!0!==w?(w=a.pageX,b=a.pageY,"visual"!==c.mode&&(b=c.Instances.Builder[0].el.getBoundingClientRect(),w=a.clientX-b.left,b=a.clientY-b.top+30),this.setPosition(this.el,
{left:w,top:b})):c.Utils.addViewPortClass(this.prevExpand))}}else!0!==w&&this.clear()}},setBreadCrumbs:function(a){for(;null!==this.breadCrumbs.firstChild;)this.breadCrumbs.removeChild(this.breadCrumbs.firstChild);this.breadCrumbs.appendChild(this.getBreadCrumbs(a));null===this.el.firstChild?this.el.appendChild(this.breadCrumbs):this.el.insertBefore(this.breadCrumbs,this.el.firstChild)},getBreadCrumbs:function(a){var b=[],d=p.createDocumentFragment();if(q===a)return d;for(;;){a=a.parentNode;var e=
a.getAttribute("data-cid");e&&b.push(e);if(a.classList.contains("module_row"))break}for(a=b.length-1;-1<a;--a){var e=p.createElement("li"),f=c.Models.Registry.lookup(b[a]),g=f.get("elType");e.textContent="column"===g?f.get("component_name"):g;e.className="tb_bread tb_bread_"+g;e.setAttribute("data-id",b[a]);d.appendChild(e)}return d},actions:function(a){var b=a.target;var d=b.tagName;if("keydown"===a.type){if("INPUT"!==d&&"TEXTAREA"!==d&&!themifyBuilder.disableShortcuts&&!l.Lightbox.$lightbox[0].contains(b)){var e=
a.keyCode;b=!0===this.isHoverMode?"tb_element_clicked":"tb_element_selected";var f=p.getElementsByClassName(b)[0];if(f!==q){a.preventDefault();a.stopPropagation();d=b=null;if(46===e||8===e)b="delete","visual"!==c.mode&&themifyBuilder.is_gutenberg_editor&&(e=p.getElementById("tb_canvas_block"),null!==e&&e.closest(".wp-block").classList.contains("is-selected")&&(a.preventDefault(),a.stopPropagation()));else if(a.ctrlKey||a.metaKey)if(67===e)b="copy";else if(68===e)b="duplicate";else if(86===e)b="paste",
a.shiftKey&&(d="style");else if(38===e||40===e){e=38===a.which?"up":"down";var h="up"===e?f.previousElementSibling:f.nextElementSibling;if(null===h)return;if(f.classList.contains("module_row")){if(!h.classList.contains("module_row"))return;var k=c.Instances.Builder[c.builderIndex].$el}else if(f.classList.contains("active_module")){if(!h.classList.contains("active_module"))return;k=g(f.parentNode.closest(".tb_holder"))}else return;h&&(h=g(f),k.sortable("option","beforeStart")(null,null,{item:h}),k.sortable("option",
"start")(null,{item:h}),"up"===e?h.prev().before(h):h.next().after(h),k.sortable("option","update")({type:"sortupdate"},{item:h}),k.sortable("option","stop")(null,{item:h,helper:null}),!0!==c.ActionBar.isHoverMode&&(c.ActionBar.clear(),f.classList.add("tb_element_selected")))}null!==b&&(a.preventDefault(),a.stopPropagation(),f=c.Models.Registry.lookup(g(f).closest("[data-cid]")[0].getAttribute("data-cid")),f.trigger(b,a,d),"delete"===b&&this.clear())}}}else if(a.preventDefault(),a.stopPropagation(),
null!==this.cid&&("LI"===d||"SPAN"===d||"A"===d)){h=(k=b.parentNode.classList.contains("tb_action_breadcrumb"))?b.getAttribute("data-id"):this.cid;e=null;f=c.Models.Registry.lookup(h);var m=b.classList;if(f)if(t.body[0].classList.remove("tb_component_menu_active"),!0===k)this.needClear=null,this.disablePosition=!0,p.getElementsByClassName("tb_element_cid_"+h)[0].click(),this.disablePosition=null,"visual"===c.mode&&(a=this.el.getBoundingClientRect(),a.right>=p.body.clientWidth&&this.setPosition(this.el,
{left:a.left,top:this.el.offsetTop+55})),this.needClear=!0;else if(e=b.getAttribute("data-href"))for(b=b.parentNode.getElementsByTagName("li"),a=b.length-1;-1<a;--a)d=(f=b[a].getAttribute("data-href"))?p.getElementById(f):null,k=b[a].classList.contains("selected"),b[a].classList.remove("selected"),null!==d&&d.classList.remove("selected"),f!==e||k||("tb_row_options"===f||"tb_rgrids"===f?this.gridMenu(d):"tb_roptions"===f&&0===d.children.length&&this.setRowOptions(d),d.classList.add("selected"),b[a].classList.add("selected"),
c.Utils.addViewPortClass(d),t.body[0].classList.add("tb_component_menu_active"));else{if(m.contains("tb_edit")||m.contains("tb_styling")||m.contains("tb_visibility_component")||m.contains("tb_swap"))e="edit";else if(m.contains("tb_duplicate"))e="duplicate";else if(m.contains("tb_save_component"))e="save";else if(m.contains("tb_delete"))e="delete";else if(m.contains("ti-import")||m.contains("ti-export"))e="importExport";else if(m.contains("tb_copy_component"))e="copy";else if(m.contains("tb_paste_component")||
m.contains("tb_paste_style"))e="paste";else{if("LI"===d||"SPAN"===d||m.contains("tb_action_more")||m.contains("tb_inner_action_more")){e=b.closest("li");if(null===e)return;a=e.parentNode;f=a.classList;d=f.contains("tb_grid_list")||f.contains("tb_column_alignment")||f.contains("tb_column_gutter")||f.contains("tb_column_direction")||f.contains("tb_column_height")||f.contains("grid_tabs");b=b.classList.contains("selected");k=a.children;if(d&&b)return;for(a=k.length-1;-1<a;--a)if(k[a].classList.remove("selected"),
!1===d)for(h=k[a].getElementsByClassName("selected"),m=h.length-1;-1<m;--m)h[m].classList.remove("selected");b||(e.classList.add("selected"),t.body[0].classList.add("tb_component_menu_active"));if(d)f.contains("tb_column_alignment")?this._columnAlignmentClicked(e):f.contains("tb_column_gutter")?this._gutterChange(e):f.contains("tb_column_direction")?this._columnDirectionClicked(e):f.contains("tb_column_height")?this._columnHeight(e):f.contains("grid_tabs")?this._switchGridTabs(e):f.contains("tb_grid_list")&&
this._gridClicked(e);else{k=null!==this.prevExpand?this.prevExpand.children:this.el.getElementsByClassName("tb_action_label_wrap")[0].children;for(a=k.length-1;-1<a;--a)k[a].classList.remove("selected");b||null!==this.prevExpand&&"column"!==this.type||(a=e.getElementsByTagName("ul")[0],a!==q&&c.Utils.addViewPortClass(a))}}return}if(!0!==this.isHoverMode)this.clear();else{var n=b.closest(".tb_action_more");null!==n&&(n=n.getElementsByTagName("ul")[0],n.style.display="none",setTimeout(function(){null!==
n&&(n.style.display="")},100))}f.trigger(e,a,b)}}},_switchGridTabs:function(a){c.ActionBar.disable=c.clearOnModeChange=!0;c.ActionBar.hoverCid=null;c.scrollTo=g(p.getElementsByClassName("tb_element_cid_"+this.cid)[0]);ThemifyConstructor.lightboxSwitch(a.getAttribute("data-id"))},_gridClicked:function(a){var b=g(a),d=b.data("grid"),e=this.type,f=g(".tb_element_cid_"+this.cid).first(),h=!1,k=c.activeBreakPoint,m="desktop"===k;a=l.clone(f.closest(".module_row"));h="subrow"===e;var n=f.find("."+e+"_inner").first();
if(m){e=n;var u=b.data("col");e=e.add(g("#tb_rgrids"));u===q&&(u=1,b.data("col",u));for(k=6;0<k;--k)e.removeClass("col-count-"+k);e.addClass("col-count-"+u);n.attr("data-basecol",u);m&&b.closest(".tb_grid_menu").find(".tb_grid_reposnive .tb_grid_list").each(function(){var a=g(this).find(".selected"),b=g(this).data("type"),d=a.data("col");d!==q&&(d>u||4===u&&3===d||4<=u&&4<=d&&u!=d)&&(a.removeClass("selected"),n.removeClass("tb_grid_classes col-count-"+n.attr("data-basecol")+" "+n.attr("data-col_"+
b)).attr("data-col_"+b,""),g(this).closest(".tb_grid_list").find("."+b+"-auto").addClass("selected"))})}else return"-auto"!==d[0]?(a="column"+d.join("-"),u=b.data("col"),3===u&&n.attr("data-basecol")>u&&(a+=" tb_3col"),n.removeClass(n.attr("data-col_tablet")+" "+n.attr("data-col_tablet_landscape")+" "+n.attr("data-col_mobile")).addClass(a+" tb_grid_classes col-count-"+n.attr("data-basecol")).attr("data-col_"+k,a)):n.removeClass("tb_grid_classes tb_3col col-count-"+n.attr("data-basecol")+" "+n.attr("data-col_"+
k)).attr("data-col_"+k,""),"visual"===c.mode&&g("body",r.document).height(p.body.scrollHeight),c.Utils.setCompactMode(n.children(".module_column")),!1;b=n.children(".module_column");m=d.length;e="module_column"+(h?" sub_column":"")+" col";for(k=0;k<m;++k)f=b.eq(k),0<f.length?f.removeClass(c.Utils.gridClass.join(" ")).addClass(e+d[k]):c.Utils._addNewColumn({newclass:e+d[k],component:h?"sub-column":"column"},n[0]);m<n.children().length&&n.children(".module_column").eq(m-1).nextAll().each(function(){g(this).find(".tb_holder").first().children().appendTo(g(this).prev().find(".tb_holder").first());
g(this).remove()});d=n.children();d.removeClass("first last");n.hasClass("direction-rtl")?(d.last().addClass("first"),d.first().addClass("last")):(d.first().addClass("first"),d.last().addClass("last"));c.Utils.columnDrag(n,!0);f=n.closest(".module_row");c.hasChanged=!0;c.Mixins.Builder.updateModuleSort(f);c.undoManager.push(f.data("cid"),a,f,"row");t.body.triggerHandler("tb_grid_changed",[f])},_columnHeight:function(a){a=g(a).data("value");if(a!==q){var b=g(".tb_element_cid_"+this.cid).first(),d=
...
f,g(".tb_element_cid_"+this.cid).first(),"row")}},gridMenu:function(a){for(var b=c.activeBreakPoint,d="desktop"===b,e=c.Models.Registry.lookup(this.cid),f=e.get(b+"_dir"),h=e.get("column_alignment"),k=e.get("column_h"),e=e.get("gutter"),m=p.getElementsByClassName("tb_element_cid_"+this.cid)[0].getElementsByClassName(this.type+"_inner")[0],n=!0===d?q:m.getAttribute("data-col_"+b),l=m.children,r=l.length,t=[],m=0;m<r;++m)t.push(c.Utils._getColClass(l[m].className.split(" ")));l="tb_rgrids"===a.id?a:
g(a).find("#tb_rgrids")[0];for(m=6;-1<m;--m)l.classList.remove("col-count-"+m);l.classList.add("col-count-"+r);t="grid-layout-"+t.join("-");a=a.getElementsByClassName("tb_grid_"+b)[0];l=a.getElementsByClassName("tb_grid_list")[0].getElementsByTagName("li");n="-auto"!==n&&n?"grid-layout-"+n.replace(/column|tb_3col/ig,"").trim():!1;!1!==d||!1!==n&&1!==r||(n=b+"-auto");for(m=l.length-1;-1<m;--m)!0===d&&l[m].classList.contains(t)||!1===d&&l[m].classList.contains(n)?l[m].classList.add("selected"):l[m].classList.remove("selected");
if("ltr"!==f)for(l=a.getElementsByClassName("tb_column_direction")[0].getElementsByTagName("li"),m=l.length-1;-1<m;--m)l[m].getAttribute("data-dir")===f?l[m].classList.add("selected"):l[m].classList.remove("selected");if(!0===d){if("col_align_top"!==h||!0===D)for(b=a.getElementsByClassName("tb_column_alignment")[0].getElementsByTagName("li"),m=b.length-1;-1<m;--m)b[m].getAttribute("data-alignment")===h?b[m].classList.add("selected"):b[m].classList.remove("selected");if("gutter-default"!==e)for(h=
a.getElementsByClassName("tb_column_gutter")[0].getElementsByTagName("li"),m=h.length-1;-1<m;--m)h[m].getAttribute("data-value")===e?h[m].classList.add("selected"):h[m].classList.remove("selected");if(k)for(h=a.getElementsByClassName("tb_column_height")[0].getElementsByTagName("li"),m=h.length-1;-1<m;--m)h[m].getAttribute("data-value")==k?h[m].classList.add("selected"):h[m].classList.remove("selected")}},setRowOptions:function(a){var b=null,d=c.activeModel,e=ThemifyConstructor.component,f=c.Models.Registry.lookup(this.cid),
...
clearSelected:function(){for(var a=c.Instances.Builder[0].el.getElementsByClassName("tb_element_selected"),b=a.length-1;-1<b;--b)a[b].classList.remove("tb_element_selected");"visual"===c.mode&&c.EdgeDrag.clearEdges()},setPosition:function(a,b){a.removeAttribute("data-top");var d=a.getBoundingClientRect();var e=d.width,f=d.height+40,h="visual"===c.mode?v.pageYOffset:c.toolbar.el.offsetTop+this.topH,k="visual"===c.mode?p.body:c.Instances.Builder[0].el,m=k.clientWidth;d=b.nodeType!==q?g(b).offset():
b;d.right=d.bottom="";d.left-=parseFloat(e/2);d.top-=f;d.left+e>m?(d.left="auto",d.right=10):0>d.left&&(d.left=30);d.top>k.clientHeight?"visual"!==c.mode&&(d.top="auto",d.bottom=50):h>d.top&&(a.dataset.top=!0,d.top+=2*f-25,"visual"!==c.mode&&(d.top-=f/2));for(var l in d)a.style[l]="auto"!==d[l]&&""!==d[l]?d[l]+"px":d[l]}};c.Forms.register_validator=function(a,b){this.Validators[a]=b};c.Forms.get_validator=function(a){return this.Validators[a]!==q?this.Validators[a]:this.Validators.not_empty};c.Forms.register_validator("email",
...
this.el.classList.remove("tb_gs_not_empty");b!==q&&this.updated();this.field.value=d.join(" ");"visual"===c.mode&&(t.triggerEvent(this.field,"keyup"),ThemifyConstructor.styles.global_styles=d.join(" "));return!0},insert:function(a){"visual"===c.mode&&!0!==this.styles[a].cssLoaded&&(c.liveStylingInstance.setCss(this.styles[a].data,q,this.styles[a]["class"]),this.styles[a].cssLoaded=!0);this.insertCallback(a)},insertCallback:function(a){null!==this.dropdown&&this.dropdown.querySelector('.global_style_item[data-class="'+
this.styles[a]["class"]+'"]').classList.add("selected");var b=this.createSelectedItem(a);this.el.getElementsByClassName("tb_gs_selected_styles")[0].appendChild(b);b=this.field.value;b=b+" "+this.styles[a]["class"];this.field.value=b.trim();this.currentStyles=this.field.value.split(" ");this.currentStyles.length&&this.el.classList.add("tb_gs_not_empty");this.updated();"visual"===c.mode&&(t.triggerEvent(this.field,"keyup"),ThemifyConstructor.styles.global_styles=b.trim())},search:function(){var a=this.el.querySelector("#global-style-search");
a.addEventListener("input",function(a){a=a.target.value.toUpperCase();for(var b=l.Lightbox.$lightbox.find(".tb_gs_list")[0].getElementsByClassName("global_style_item"),c=0;c<b.length;c++){var f=b[c].getElementsByClassName("global_style_title")[0];f&&(-1<f.innerHTML.toUpperCase().indexOf(a)?b[c].style.display="":b[c].style.display="none")}});a.addEventListener("focus",function(){this.el.classList.add("tb_gs_dropdown_opened");this.el.classList.add("tb_gs_searching")}.bind(this));a.addEventListener("blur",
function(){this.el.classList.remove("tb_gs_dropdown_opened");this.el.classList.remove("tb_gs_searching")}.bind(this))},addItemToDropdown:function(a){if(null!=this.dropdown){var b=this.styles[a],d=p.createElement("div");d.className="global_style_item";d.className+=-1!==this.currentStyles.indexOf(b["class"])?" selected":"";d.dataset["class"]=b["class"];d.dataset.styleId=a;a=p.createElement("span");a.className="global_style_title";a.innerText=b.title;d.appendChild(a);a=p.createElement("span");a.className=
"global_style_type";a.innerText=b.type;d.appendChild(a);this.dropdown.insertBefore(d,this.dropdown.firstChild)}},loadMore:function(a){for(var b=[],d=this,c=Object.keys(this.styles),f=c.length-1;-1<f;--f)b.push(c[f]),a&&this.addItemToDropdown(c[f]);g.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_gs_posts",tb_load_nonce:themifyBuilder.tb_load_nonce,loaded:b},success:function(a){d.styles=d.extend(d.styles,a);a=Object.keys(a);10>a.length&&(d.allLoaded=!0);for(var b=
a.length-1;-1<b;--b)d.addItemToDropdown(a[b]);0===d.dropdown.querySelectorAll(".global_style_item:not(.selected)").length&&(d.dropdown.getElementsByClassName("tb_no_gs_item")[0].style.display="block");d.loadingPosts=!1}})},initDropdown:function(){this.dropdown=this.el.getElementsByClassName("tb_gs_list")[0];this.search();if(10<Object.keys(this.styles).length||this.allLoaded){for(var a=Object.keys(this.styles),b=a.length-1;-1<b;--b)this.addItemToDropdown(a[b]);0===this.dropdown.querySelectorAll(".global_style_item:not(.selected)").length&&
(this.dropdown.getElementsByClassName("tb_no_gs_item")[0].style.display="block")}else this.loadMore(!0);var a=new SimpleBar(this.dropdown),b=this.dropdown.getElementsByClassName("simplebar-content"),d=this.dropdown;b.length&&(this.dropdown=b[0],d=a.getScrollElement());d.addEventListener("scroll",this.scrollLoadMore.bind(this))},initClickEvent:function(a){!0!==this.initVars&&(this.field=l.Lightbox.$lightbox[0].querySelector("#global_styles"),this.initCurrentStyles(),this.initVars=!0);this.initContent||
(this.initHTML(),this.initContent=!0);var b=a.target,d=b.classList;if("insert"===b.dataset.action){if("LABEL"===b.nodeName||d.contains("tb_open_gs"))return!0;a.preventDefault();a.stopImmediatePropagation();"insert"===b.dataset.action&&(b.focus(),b.dataset.init===q?(this.initDropdown(),b.dataset.init=!0):(a=this.dropdown.getElementsByClassName("tb_no_gs_item")[0],0===this.dropdown.querySelectorAll(".global_style_item:not(.selected)").length?a.style.display="block":a.style.display="none"))}else d.contains("global_style_title")?
(a.preventDefault(),this.el.classList.remove("tb_gs_dropdown_opened"),g(b).parents(".tb_gs_icon").focus(),this.insert(b.parentElement.dataset.styleId),0===this.dropdown.querySelectorAll(".global_style_item:not(.selected)").length&&(this.dropdown.getElementsByClassName("tb_no_gs_item")[0].style.display="block")):d.contains("tb_delete_gs")?(a.preventDefault(),a.stopImmediatePropagation(),this["delete"](b.parentElement.getAttribute("data-css"),b.parentElement.getAttribute("data-id"))&&(b.parentElement.outerHTML=
""),g(c.GS.el.querySelector(".tb_gs_icon")).focus()):"save"===b.dataset.action?(a.preventDefault(),a.stopImmediatePropagation(),this.saveAs()):d.contains("tb_gs_edit")&&this.liveEdit(b.parentNode.dataset.id)},scrollLoadMore:function(a){this.allLoaded||(a=a.target,a=Math.max(a.scrollHeight-(a.scrollTop+a.offsetHeight),0),!this.loadingPosts&&0<a&&100>=a&&(this.loadingPosts=!0,this.loadMore()))},extraClass:function(){var a=!1,b=!1,d=this;this.currentStyles.some(function(c){if(b&&a)return!0;if(c=d.findBySlug(c))c=
"row"===d.styles[c.id].type?d.styles[c.id].data[0].styling.background_repeat:d.styles[c.id].data[0].cols[0].styling.background_repeat,"builder-parallax-scrolling"!==c||a||(a=!0),"builder-zoom-scrolling"!==c||b||(b=!0)});var e=p.querySelector('[data-cid="'+c.activeModel.cid+'"]');a?e.classList.add("builder-parallax-scrolling"):"builder-parallax-scrolling"!==ThemifyConstructor.values.background_repeat&&e.classList.remove("builder-parallax-scrolling");b?e.classList.add("builder-zoom-scrolling"):"builder-zoom-scrolling"!==
ThemifyConstructor.values.background_repeat&&e.classList.remove("builder-zoom-scrolling");d=null},updated:function(){if("visual"!==c.mode)return!1;var a=c.activeModel.get("elType"),a="subrow"===a?"row":a;if("row"===a||"column"===a)this.extraClass(),this.addOverlay(),"row"===a&&this.addFrame()},addOverlay:function(){var a=c.activeModel.get("elType"),a="subrow"===a?"row":a;if(!c.liveStylingInstance.getComponentBgOverlay().length){var b=!1,d=this,e,f;this.currentStyles.some(function(c){if(b)return!0;
if(c=d.findBySlug(c))c="row"===a?c.data[0].styling:c.data[0].cols[0].styling,f=q!==c["cover_color-type"]||"color"===c["cover_color-type"]?"color":"gradient",e="color"===f?c.cover_color:c["cover_gradient-gradient"],d.isEmpty(e)&&(f=q!==c.cover_color_hover||"hover_color"===c["cover_color_hover-type"]?"color":"gradient",e="color"===f?c.cover_color_hover:c["cover_gradient_hover-gradient"]),d.isEmpty(e)||(b=!0)});b&&c.liveStylingInstance.addOrRemoveComponentOverlay(f,"cover_color",e)}},addFrame:function(){!0!==
this.initVars&&(this.field=l.Lightbox.$lightbox[0].querySelector("#global_styles"),this.initCurrentStyles(),this.initVars=!0);for(var a=["top","bottom","left","right"],b=[],d=this,e=a.length-1;-1<e;--e){var f=c.liveStylingInstance.$liveStyledElmt.children(".tb_row_frame_"+a[e]);f.length&&a.splice(e,1);f=null}if(0===a.length)return!0;var g={};this.currentStyles.some(function(c){if(c=d.findBySlug(c))g=c.data[0].styling,a.some(function(a){if(-1===b.indexOf(a)){var c=a+"-frame_type",d=a+"-frame_layout",
e=a+"-frame_custom";q!==g[c]&&(g[c]===a+"-presets"&&q!==g[d]&&""!==g[d]||g[c]===a+"-custom"&&q!==g[e]&&""!==g[e])&&b.push(a)}})});for(e=b.length-1;-1<e;--e)c.liveStylingInstance.addOrRemoveFrame(b[e],g[b[e]+"-frame_location"])},liveEdit:function(a){var b=this.styles[a];a={gs:a};this.previousModel=c.activeModel.cid;"row"===b.type?(a=this.extend(a,b.data[0]),b=tb_app.Views.init_row(a)):"column"===b.type?(a=this.extend(a,b.data[0].cols[0]),b=tb_app.Views.init_column(a)):(a=this.extend(a,b.data[0].cols[0].modules[0]),
b=tb_app.Views.init_module(a));b.model.trigger("edit",null)},modulePanel:function(a){a?l.Lightbox.$lightbox[0].className+=" gs_post":l.Lightbox.$lightbox[0].classList.remove("gs_post")},saveLiveEdit:function(a){c.saving=!0;var b=this.styles[c.activeModel.attributes.gs];b.css=null;delete ThemifyConstructor.values.cid;ThemifyConstructor.setStylingValues(c.activeBreakPoint);var d=c.Utils.clear(ThemifyConstructor.values);"row"===b.type?b.data[0].styling=d:"column"===b.type?b.data[0].cols[0].styling=d:
b.data[0].cols[0].modules[0].mod_settings=d;g("."+b["class"]).removeClass("tb_visual_hover");var e=this;g.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_update_global_style",tb_load_nonce:themifyBuilder.tb_load_nonce,data:b.data,id:b.id},beforeSend:function(){l.showLoader("show")},error:function(){l.showLoader("error");l.Lightbox.close()},success:function(){e.styles[b.id].data=b.data;l.Lightbox.close();e.reopenPreviousPanel(a);l.showLoader("hide");c.saving=!1}})},reopenPreviousPanel:function(a){q!==
a?a.model.trigger("edit",a.e,a.target):null!==this.previousModel&&l.Lightbox.$lightbox[0].classList.contains("gs_post")&&(this.modulePanel(!1),c.Models.Registry.lookup(this.previousModel).trigger("edit",null),this.previousModel=null)},stylingOverlay:function(){var a=p.createElement("div");a.className="tb_gs_options_overlay";var b=p.createElement("p");b.textContent=themifyBuilder.i18n.has_gs;a.appendChild(b);a.addEventListener("click",function(){this.parentNode.removeChild(this)},{once:!0});return a}}})(jQuery,
Backbone,Themify,window,window.top,document,ThemifyBuilderCommon,void 0);
