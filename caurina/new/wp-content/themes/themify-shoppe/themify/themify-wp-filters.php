 ...
 * @return mixed
 */
function themify_search_excludes_cpt_filter($query){
 if ($query->is_search  && ! is_admin() && $query->is_main_query()) {
	$query = themify_search_excludes_cpt($query);
 }
 return $query;
}
...
add_filter( 'pre_get_posts', 'themify_search_excludes_cpt_filter', 999 );
