...
class WP_Http {
	 ...
	 * file and this will only allow 127.0.0.1 and your site to make requests. The constant
	...
	public function block_request( $uri ) {
		...
		if ( '127.0.0.1' == $check['host'] || ( isset( $home['host'] ) && $home['host'] == $check['host'] ) ) {
			 ...
			 *
			 * A local request is one to `127.0.0.1` or to the same host as the site itself.
			 *
			 * @since 2.8.0
			 *
