 ...
 * You do not need to have 127.0.0.1 and the site host in this list, because they will not be passed
 ...
 *     define('WP_PROXY_BYPASS_HOSTS', '127.0.0.1, www.example.com, *.wordpress.org');
 *
...
class WP_HTTP_Proxy {
	 ...
	 *
	 * We want to keep 127.0.0.1 and the site URL from being sent through the proxy, because
	...
	public function send_through_proxy( $uri ) {
		...
		if ( '127.0.0.1' == $check['host'] || ( isset( $home['host'] ) && $home['host'] == $check['host'] ) ) {
			return false;
		}
